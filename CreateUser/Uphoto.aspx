<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Uphoto.aspx.vb" Inherits="photo" %>
...
<body>
    ...
    <table width="100%" style="font-size: 10pt; font-family: 'Trebuchet MS'; font-style: italic; color:Gray; ">
        ...
        <asp:Label ID="lblMsg" runat="server" Text="Label" Font-Bold="True" Font-Italic="True" Font-Names="Trebuchet MS"></asp:Label>
    </div>
