    ...
    Private Sub DBind()
        ...
        Try
            ...
            Try
                ...
                '                DS = clsPRep.SearchPrevReports(Session("ContractorID"), Session("WorkGroupID"), Request("DDLAccounts").ToString, Request("txtPFName").ToString, Request("txtPLName").ToString, Request("txtTemplate").ToString)
