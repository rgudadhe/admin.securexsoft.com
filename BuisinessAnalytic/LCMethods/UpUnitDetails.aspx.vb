...
Partial Class UpUnitDetails
    ...
    Protected Sub ShowDetails()
        ...
        If DTSet1.Tables.Count > 0 Then
            For Each DRRec As Data.DataRow In DTSet1.Tables(0).Rows
                ...
                If Not IsDBNull(DRRec("IsFaxBilling")) Then
                    If DRRec("IsFaxBilling").ToString Then
                        chkFax1.Checked = True
                        ' txtFax1.Enabled = True
                        txtFax1.Text = DRRec("FaxCharges").ToString
                    Else
                        chkFax1.Checked = False
                ...
                Else
                    ...
                    ' txtFax1.Enabled = False
                End If
                If Not IsDBNull(DRRec("IsDiscountEnabled")) Then
                    If DRRec("IsDiscountEnabled").ToString Then
                        chkDiscount1.Checked = True
                        '   txtDiscount1.Enabled = True
                        txtDiscount1.Text = DRRec("Discount").ToString
                    Else
                ...
                Else
                    ...
                    'txtDiscount1.Enabled = False
                End If
                If Not IsDBNull(DRRec("IsCutPasteBilling")) Then
                    If DRRec("IsCutPasteBilling").ToString Then
                        chkCutPaste1.Checked = True
                        '   txtCutPaste1.Enabled = True
                        txtCutPaste1.Text = DRRec("CutPasteBilling").ToString
                    Else
                        chkCutPaste1.Checked = False
                        txtCutPaste1.Text = String.Empty
                        '  txtCutPaste1.Enabled = False
                    End If
                ...
                Else
                    ...
                    'txtCutPaste1.Enabled = False
                End If
                If Not IsDBNull(DRRec("IsVPNBilling")) Then
                    If DRRec("IsVPNBilling").ToString Then
                        chkVPN1.Checked = True
                        '   txtVPN1.Enabled = True
                        txtVPN1.Text = DRRec("VPNCharges").ToString
                    Else
                        chkVPN1.Checked = False
                        txtVPN1.Text = String.Empty
                        '  txtVPN1.Enabled = False
                    End If
                ...
                Else
                    ...
                    DLCycle.Items(1).Selected = True
                End If
                'Response.Write(DRRec("StatChgPerReport"))
                If IsDBNull(DRRec("StatChgPerReport")) Then
                    DLSTATChg.Items(1).Selected = False
                    DLSTATChg.Items(0).Selected = True

                ElseIf DRRec("StatChgPerReport") Then
                    DLSTATChg.Items(0).Selected = False
                    DLSTATChg.Items(1).Selected = True
                Else
                    DLSTATChg.Items(1).Selected = False
                    DLSTATChg.Items(0).Selected = True
                End If
                ...
                If HMode.Value = "S" Or HMode.Value = "" Then
                    WTRow.Visible = True
                    'Dim SQLCmd1 As New SqlCommand("Select Top 1 * from AdminSecureweb.dbo.BillDetails where AccountID='" & DLAct.SelectedValue & "' order by ModDate Desc", New SqlConnection(strConn))
    ...
    Protected Sub SubButton_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles SubButton.Click
        ...
        Try
            ...
            If chkFax1.Checked Then
                varUpdate = varUpdate & ",IsFaxBilling=1, FaxCharges = '" & Request("txtFax1") & "'"
            Else
                varUpdate = varUpdate & ",IsFaxBilling=0, FaxCharges = 0"
            End If
            If chkVPN1.Checked Then
                varUpdate = varUpdate & ",IsVPNBilling=1, VPNCharges = '" & Request("txtVPN1") & "'"
            Else
                varUpdate = varUpdate & ",IsVPNBilling=0, VPNCharges = 0"
            End If
            If chkCutPaste1.Checked Then
                varUpdate = varUpdate & ",IsCutPasteBilling=1, CutPasteBilling = '" & Request("txtCutPaste1") & "'"
            Else
                varUpdate = varUpdate & ",IsCutPasteBilling=0, CutPasteBilling = 0"
            End If
            If DLSTATChg.SelectedValue Then
                varUpdate = varUpdate & ",StatChgPerReport=1"
            Else
                varUpdate = varUpdate & ",StatChgPerReport=0"
            End If
            If chkDiscount1.Checked Then
                varUpdate = varUpdate & ",IsDiscountEnabled=1, Discount = '" & Request("txtDiscount1") & "'"
            Else
                varUpdate = varUpdate & ",IsDiscountEnabled=0, Discount = 0"
            End If
            'Response.Write(varUpdate)

            varWhere = " where AccountID = '" & DLAct.SelectedValue & "' "
            RetActVal = New DALBASE().ExecuteDynamicQuery(oConn, oTrans, New DynamicSQL().getUpdateQuery(varUpdate, "AdminETS.dbo.tblAccounts", varWhere))
            If HMode.Value = "S" Or HMode.Value = "" Then
                If HRecExist.Value = "Yes" Then
                    ...
                    varUpdate = SQLStr
                    varWhere = " where AccountID = '" & DLAct.SelectedValue & "' "
                    RetVal = New DALBASE().ExecuteDynamicQuery(oConn, oTrans, New DynamicSQL().getUpdateQuery(varUpdate, "AdminSecureweb.dbo.BillDetails", varWhere))

                Else
                    If DLWType.Items(0).Selected = False Then

                        If Request("DLMethodID1") = "" Then
                            RetVal = New DALBASE().ExecuteDynamicQuery(oConn, oTrans, New DynamicSQL().getInsertQuery("Accountid, Rate, MiscRate, statRate, ModDate, WTMode, LCMethodID", "'" & HAccountID.Value & "',  '" & Request("TxRate1") & "',  '" & Request("TxMRate1") & "',  '" & Request("TxSTRate1") & "',   '" & Now & "', '" & Request("DLWType") & "',NULL", "AdminSecureweb.dbo.BillDetails"))
                        Else
                            RetVal = New DALBASE().ExecuteDynamicQuery(oConn, oTrans, New DynamicSQL().getInsertQuery("Accountid, Rate, MiscRate, statRate, ModDate, WTMode, LCMethodID", "'" & HAccountID.Value & "',  '" & Request("TxRate1") & "',  '" & Request("TxMRate1") & "',  '" & Request("TxSTRate1") & "',   '" & Now & "', '" & Request("DLWType") & "', '" & Request("DLMethodID1") & "' ", "AdminSecureweb.dbo.BillDetails"))
                        End If
                    Else
                        If Request("DLMethodID1") = "" Then
                            RetVal = New DALBASE().ExecuteDynamicQuery(oConn, oTrans, New DynamicSQL().getInsertQuery("Accountid,Consult,HP,Discharge,IME,Letter,PrNote,OpNote,PsychEval,Rate, statRate, ModDate, WTMode, LCMethodID", "'" & HAccountID.Value & "',  '" & Request("Consult") & "', '" & Request("HP") & "', '" & Request("Discharge") & "', '" & Request("IME") & "', '" & Request("Letter") & "', '" & Request("PrNote") & "', '" & Request("OpNote") & "', '" & Request("PsychEval") & "', '" & Request("rate") & "', '" & Request("statrate") & "',   '" & Now & "', '" & Request("DLWType") & "',NULL", "AdminSecureweb.dbo.BillDetails"))
                        Else
                            RetVal = New DALBASE().ExecuteDynamicQuery(oConn, oTrans, New DynamicSQL().getInsertQuery("Accountid,Consult,HP,Discharge,IME,Letter,PrNote,OpNote,PsychEval,Rate, statRate, ModDate, WTMode, LCMethodID", "'" & HAccountID.Value & "',  '" & Request("Consult") & "', '" & Request("HP") & "', '" & Request("Discharge") & "', '" & Request("IME") & "', '" & Request("Letter") & "', '" & Request("PrNote") & "', '" & Request("OpNote") & "', '" & Request("PsychEval") & "', '" & Request("rate") & "', '" & Request("statrate") & "',   '" & Now & "', '" & Request("DLWType") & "', '" & Request("DLMethodID1") & "'", "AdminSecureweb.dbo.BillDetails"))
                        End If
            ...
            ElseIf HMode.Value = "DV" Then
                ...
                Else
                    SQLStr = "Insert Into AdminSecureweb.dbo.BillDetails (Accountid, Rate, MiscRate, statRate, ModDate, LCMethodID) Values ('" & HAccountID.Value & "',  '" & Request("TxRate1") & "',  '" & Request("TxMRate1") & "',  '" & Request("TxSTRate1") & "',   '" & Now & "'"
                    If Request("DLMethodID1") = "" Then
                        RetVal = New DALBASE().ExecuteDynamicQuery(oConn, oTrans, New DynamicSQL().getInsertQuery("Accountid, Rate, MiscRate, statRate, ModDate, LCMethodID", "'" & HAccountID.Value & "',  '" & Request("TxRate1") & "',  '" & Request("TxMRate1") & "',  '" & Request("TxSTRate1") & "',   '" & Now & "',NULL", "AdminSecureweb.dbo.BillDetails"))
                    Else
                        RetVal = New DALBASE().ExecuteDynamicQuery(oConn, oTrans, New DynamicSQL().getInsertQuery("Accountid, Rate, MiscRate, statRate, ModDate, LCMethodID", "'" & HAccountID.Value & "',  '" & Request("TxRate1") & "',  '" & Request("TxMRate1") & "',  '" & Request("TxSTRate1") & "',   '" & Now & "', '" & Request("DLMethodID1") & "'", "AdminSecureweb.dbo.BillDetails"))
                    End If
            ...
            ElseIf HMode.Value = "LC" Or HMode.Value = "TT" Or HMode.Value = "DC" Or HMode.Value = "TW" Then
                ...
                For i = 1 To HRecCount.Value
                    ...
                    If Not RetVal = 1 Then
                        SQLStr = "Insert Into AdminSecureweb.dbo.BillDetails (Accountid, SubActID, Rate, MiscRate, statRate, MinBilling, Cycle, ModDate, LCMethodID) Values ('" & HAccountID.Value & "',  '" & Request("HActID" & i) & "', '" & Request("TxRate" & i) & "',  '" & Request("TxMRate" & i) & "',  '" & Request("TxSTRate" & i) & "', '" & Request("TxMBilling") & "','" & Request("DLCycle") & "',  '" & Now & "'"
                        If Request("DLMethodID" & i) = "" Then
                            RetVal = New DALBASE().ExecuteDynamicQuery(oConn, oTrans, New DynamicSQL().getInsertQuery("Accountid, SubActID, Rate, MiscRate, statRate, MinBilling, Cycle, ModDate, LCMethodID", "'" & HAccountID.Value & "',  '" & Request("HActID" & i) & "', '" & Request("TxRate" & i) & "',  '" & Request("TxMRate" & i) & "',  '" & Request("TxSTRate" & i) & "', '" & Request("TxMBilling") & "','" & Request("DLCycle") & "',  '" & Now & "',NULL", "AdminSecureweb.dbo.BillDetails"))
                        Else
                            RetVal = New DALBASE().ExecuteDynamicQuery(oConn, oTrans, New DynamicSQL().getInsertQuery("Accountid, SubActID, Rate, MiscRate, statRate, MinBilling, Cycle, ModDate, LCMethodID", "'" & HAccountID.Value & "',  '" & Request("HActID" & i) & "', '" & Request("TxRate" & i) & "',  '" & Request("TxMRate" & i) & "',  '" & Request("TxSTRate" & i) & "', '" & Request("TxMBilling") & "','" & Request("DLCycle") & "',  '" & Now & "', '" & Request("DLMethodID" & i) & "' ", "AdminSecureweb.dbo.BillDetails"))
                        End If
                    End If
        ...
        'SQLStr = "update AdminETS.dbo.tblAccounts set MinBilling = '" & TxMBilling.Text & "', Cycle = '" & DLCycle.SelectedValue & "' where AccountID = '" & DLAct.SelectedValue & "' "
        ...
        'If HMode.Value = "S" Or HMode.Value = "" Then
        '    If HRecExist.Value = "Yes" Then
        '        SQLStr = "Update AdminSecureweb.dbo.BillDetails Set "
        '        If DLWType.Items(0).Selected = False Then
        '            SQLStr = SQLStr & " Rate = '" & Request("TxRate1") & "', "
        '            SQLStr = SQLStr & " MiscRate = '" & Request("TxMRate1") & "', "
        '            SQLStr = SQLStr & " StatRate = '" & Request("TxSTRate1") & "', "
        ...
        '    Else
        '        If DLWType.Items(0).Selected = False Then
        '            SQLStr = "Insert Into AdminSecureweb.dbo.BillDetails (Accountid, Rate, MiscRate, statRate, ModDate, WTMode, LCMethodID) Values ('" & HAccountID.Value & "',  '" & Request("TxRate1") & "',  '" & Request("TxMRate1") & "',  '" & Request("TxSTRate1") & "',   '" & Now & "', '" & Request("DLWType") & "'"
        '            If Request("DLMethodID1") = "" Then
        '                SQLStr = SQLStr & ", NULL)"
        '            Else
    ...
    Protected Sub chkCutPaste1_CheckedChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles chkCutPaste1.CheckedChanged
        If chkCutPaste1.Checked Then
            txtCutPaste1.Enabled = True
            txtCutPaste1.Text = String.Empty
        Else
    ...
    Protected Sub chkDiscount1_CheckedChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles chkDiscount1.CheckedChanged
        If chkDiscount1.Checked Then
            txtDiscount1.Enabled = True
            txtDiscount1.Text = String.Empty
        Else
    ...
    'Protected Sub chkFax1_CheckedChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles chkFax1.CheckedChanged
    '    If chkFax1.Checked Then
    '        txtFax1.Enabled = True
    '        txtFax1.Text = String.Empty
    '    Else
    ...
    'Protected Sub chkVPN1_CheckedChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles chkVPN1.CheckedChanged
    '    If chkVPN1.Checked Then
    '        txtVPN1.Enabled = True
    '        txtVPN1.Text = String.Empty
