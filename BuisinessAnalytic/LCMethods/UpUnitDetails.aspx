        ...
        <asp:Table ID="Table3" runat="server" Width="250">
            ...
            <asp:TableRow ID="WTRow">
             ...
             <asp:TableRow ID="TableRow15">
                <asp:TableCell HorizontalAlign="Right" CssClass="alt5" >
                    <div style="text-align:right">
                        STAT Charges per Report
                    </div>
                </asp:TableCell>
                <asp:TableCell HorizontalAlign="Left" CssClass="alt5" >
                    <asp:DropDownList ID="DLSTATChg" runat="server" CssClass="common">
            ...
            <asp:TableRow>
             ...
             <asp:TableRow>
                ...
                <asp:TableCell   HorizontalAlign="Left" CssClass="alt5"  >
                    <asp:TextBox ID="txtFax1" runat="server" Width="50" CssClass="common"></asp:TextBox>
                </asp:TableCell>
                  <asp:TableCell   HorizontalAlign="Left" CssClass="alt5"  >
                     <asp:CheckBox ID="chkFax1" runat="server" />
                </asp:TableCell>
            </asp:TableRow> 
             <asp:TableRow>
                <asp:TableCell HorizontalAlign="Right" CssClass="alt5">
                ...
                <asp:TableCell   HorizontalAlign="Left" CssClass="alt5"  >
                    <asp:TextBox ID="txtCutPaste1" runat="server" Width="50" CssClass="common"></asp:TextBox>
                </asp:TableCell>
                 <asp:TableCell   HorizontalAlign="Left" CssClass="alt5"  >
                     <asp:CheckBox ID="chkCutPaste1" runat="server" />
                </asp:TableCell>
            </asp:TableRow> 
             <asp:TableRow>
                <asp:TableCell HorizontalAlign="Right" CssClass="alt5">
                ...
                <asp:TableCell   HorizontalAlign="Left" CssClass="alt5"  >
                    <asp:TextBox ID="txtDiscount1" runat="server" Width="50" MaxLength="2" CssClass="common"></asp:TextBox>
                </asp:TableCell>
                 <asp:TableCell   HorizontalAlign="Left" CssClass="alt5"  >
                     <asp:CheckBox ID="chkDiscount1" runat="server" />
                </asp:TableCell>
            </asp:TableRow> 
              <asp:TableRow>
                <asp:TableCell HorizontalAlign="Right" CssClass="alt5">
                ...
                <asp:TableCell   HorizontalAlign="Left" CssClass="alt5"  >
                    <asp:TextBox ID="txtVPN1" runat="server" Width="50"  CssClass="common"></asp:TextBox>
                </asp:TableCell>
                 <asp:TableCell   HorizontalAlign="Left" CssClass="alt5"  >
                     <asp:CheckBox ID="chkVPN1" runat="server" />
                </asp:TableCell>
            </asp:TableRow> 
