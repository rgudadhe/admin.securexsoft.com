<%@ Page Language="VB" AutoEventWireup="false" CodeFile="UserRates.aspx.vb" Inherits="Billing_LCMethods_LCMethodology" %>
        ...
        <tr>
                <td style="text-align: left;" class="HeaderDiv" valign="top" >
                    Contractor</td>
                        ...
                        <asp:DropDownList ID="DLUser" runat="server" AutoPostBack="true" CssClass ="common" >
                        </asp:DropDownList>
               </tr>
