<%@ Page Language="VB" AutoEventWireup="false" CodeFile="TemplateWise.aspx.vb" Inherits="TemplateWise" %>
...
<body style="text-align: center">
    ...
    <asp:Table ID="Table1" runat="server" Width="70%" BorderWidth="2" GridUnits="Both"
        ...
        <asp:TableRow CssClass="tblbg">
            <asp:TableCell Font-Names="Arial" Font-Size="8" ColumnSpan="4" Font-Bold="True">Existing Templates Group 
            </asp:TableCell>
        </asp:TableRow>
        <asp:TableRow CssClass="tblbg2">
            ...
            <asp:TableCell Font-Names="Arial" Font-Size="8">Template Name 
            </asp:TableCell>
    ...
    <asp:Table ID="Table2" runat="server" Width="70%" GridUnits="Both" CellPadding="2"
        ...
        <asp:TableRow CssClass="tblbgbody">
            <asp:TableCell Font-Names="Arial" Font-Size="8" Font-Bold="True" ColumnSpan="6">Create Templates Group 
            </asp:TableCell>
        </asp:TableRow>
        <asp:TableRow CssClass="tblbg">
    ...
    <asp:Panel ID="Panel1" runat="server">
        <asp:Table ID="TblDetails" runat="server"  CssClass="common">
            <asp:TableHeaderRow BorderStyle="Solid">
                <asp:TableHeaderCell CssClass="alt1">New Templates</asp:TableHeaderCell>
            </asp:TableHeaderRow>
            <asp:TableRow>
