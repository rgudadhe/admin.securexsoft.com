<%@ Page Language="VB" AutoEventWireup="false" CodeFile="PlatformRates.aspx.vb" Inherits="Billing_LCMethods_LCMethodology" %>
        ...
        <asp:Panel ID="Panel1" runat="server" HorizontalAlign="Left">
            <div>
                ...
                <PagerSettings PreviousPageText="Previous" PageButtonCount="25" Mode="NumericFirstLast" LastPageText="Last Page" FirstPageText="First Page" NextPageText="Next Page"></PagerSettings>
                          ...
                          <Columns>
                         <asp:TemplateField HeaderText="Level Name" HeaderStyle-CssClass="alt1">
                           <ItemTemplate>                    <asp:Label ID="lblLevel" runat="server" Text='<%# Eval("Name") %>' />  
                                       </ItemTemplate>              
                                       </asp:TemplateField> 
                              ...
                              <asp:BoundField DataField="Currency"  HeaderText="Currency" SortExpression="Currency" HeaderStyle-CssClass="alt1" />
                                ...
                                <%--<asp:TemplateField HeaderText="Level" HeaderStyle-CssClass="alt1" Visible="false"   >
                           <ItemTemplate>                    <asp:Label ID="lblLevelID" runat="server" Text='<%# Eval("Level") %>' />  
                                       </ItemTemplate>              
                                       </asp:TemplateField>  --%>
