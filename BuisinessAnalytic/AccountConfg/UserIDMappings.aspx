<%@ Page Language="VB" AutoEventWireup="false" CodeFile="UserIDMappings.aspx.vb" Inherits="UserPhyAssgn_Default" EnableViewState="True" %>
   ...
   function addRowToTable()
{
  ...
  var sel1 = document.getElementById('UserName1').cloneNode(true);
  sel1.name = 'UserName' + iteration;
  sel1.value='';
  ...
  var sel2 = document.getElementById('MTID1').cloneNode(true);
  sel2.name = 'MTID' + iteration;
  sel2.value='';
  ...
  var sel3 = document.getElementById('QAID1').cloneNode(true);
  sel3.name = 'QAID' + iteration;
  sel3.value='';
  cell3.appendChild(sel3);
  
   var cell4 = row.insertCell(3);
  var sel4 = document.getElementById('QABID1').cloneNode(true);
  sel4.name = 'QABID' + iteration;
  sel4.value='';
                        ...
                        <asp:Table ID="Table2" runat="server" Width="100%">
                            ...
                            <asp:TableRow ID="TableRow4" runat="server">
                                ...
                                <asp:TableCell ID="TableCell9" runat="server">
                                    <asp:TextBox ID="MTID1" runat="server"></asp:TextBox></asp:TableCell>
                                    
                                    <asp:TableCell ID="TableCell11" runat="server">
                                    <asp:TextBox ID="QAID1" runat="server"></asp:TextBox></asp:TableCell>
                                    
                                    <asp:TableCell ID="TableCell1" runat="server">
                                    <asp:TextBox ID="QABID1" runat="server"></asp:TextBox></asp:TableCell>
                            </asp:TableRow>
                        </asp:Table>
