...
Partial Class MIS_DailyMins
    ...
    Protected Sub ShowActDetails()
        ...
        strQuery = " Select  * from AdminSecureweb.dbo.tbltranscriptionclientMain where datemodified between '" & C1SDate & "' and '" & C2EDate & "' and  AccountID = '" & DLAct.SelectedValue & "' and (Location is null OR location not in (Select LocCode from AdminETS.dbo.tblaccountslocations where AccountID = '" & DLAct.SelectedValue & "' )) Order by  jobnumber"
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        If Not IsPostBack Then
            Dim strConn As String
            strConn = System.Configuration.ConfigurationManager.AppSettings("ETSCon")
            Dim SQLCmd1 As New SqlCommand("Select * from AdminETS.dbo.tblaccounts where mode='LC' and contractorid ='" & Session("contractorid").ToString & "' and (isdeleted is NULL OR isdeleted=0) order by Accountname", New SqlConnection(strConn))
            Try
