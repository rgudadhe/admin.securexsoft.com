...
Partial Class EditTempWise
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        If Not IsPostBack Then
            ...
            Dim SQLCmd1 As New SqlCommand("Select GrpTempName, Description, IsNull(SepInvoice, 'False') as SepInvoice from AdminSecureweb.dbo.tblGrpTemplates where GrpTempID = '" & Request("GrpTempID") & "'", New SqlConnection(strConn))
            'Response.Write("Select * from AdminSecureweb.dbo.tblGrpTemplates where GrpTempID = '" & Request("GrpTempID") & "'")
            ...
            Try
                ...
                If DRRec1.HasRows = True Then
                    If DRRec1.Read Then
                        TxtGrpTempName.Text = DRRec1("GrpTempName").ToString
    ...
    Protected Sub ShowDetails()
        ...
        Dim strConn As String
        strConn = System.Configuration.ConfigurationManager.AppSettings("ETSCon")
        SQLSTR = "Select Distinct T.TemplateName, T.TemplateID from AdminETS.dbo.tblPhysiciansTemplate PT, AdminETS.dbo.tblTemplates T, AdminETS.dbo.tblPhysicians P,AdminETS.dbo.tblAccounts A Where P.PhysicianID=PT.PhysicianID and PT.TemplateID = T.TemplateID and P.AccountID = A.AccountID and A.accountID = '" & Request("AccountID") & "' and PT.TemplateID not in (Select TemplateID from AdminSecureweb.dbo.tblAssignTemplates where AccID='" & Request("AccountID") & "') order by T.TemplateName"
        ...
        SQLSTR = "Select TemplateName, TemplateID from AdminETS.dbo.tblTemplates Where TemplateID  in (Select TemplateID from AdminSecureweb.dbo.tblAssignTemplates where GrpTempID = '" & Request("GrpTempID") & "')"
        ...
        Try
            ...
            If DRRec3.HasRows = True Then
                ...
                While (DRRec3.Read)
                    Dim LI As New ListItem
                    LI.Text = DRRec3("TemplateName")
                    LI.Value = DRRec3("TemplateID").ToString
    ...
    Protected Sub btnAssign_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnAssign.Click
        ...
        Try
            ...
            strConn = System.Configuration.ConfigurationManager.AppSettings("ETSCon")
            SQLSTR = "select * from AdminSecureweb.dbo.tblGrpTemplates where GrpTempID Not In ('" & Request("GrpTempID") & "') and AccID='" & Request("AccountID") & "' and GrpTempName='" & TxtGrpTempName.Text & "'"
            'Response.Write(SQLSTR)
            Dim SQLCmd2 As New SqlCommand(SQLSTR, New SqlConnection(strConn))
            Try
                SQLCmd2.Connection.Open()
            ...
            Finally
                ...
                End If
            End Try
            SQLSTR = "Update AdminSecureweb.dbo.tblGrpTemplates Set GrpTempName = '" & TxtGrpTempName.Text & "', Description = '" & TxtDesc.Text & "', SepInvoice = '" & DLSepInvoice.SelectedValue & "'  where AccID='" & Request("AccountID") & "' and GrpTempID='" & Request("GrpTempID") & "'"
            ...
            SQLSTR = "DELETE FROM AdminSecureweb.dbo.tblAssignTemplates  where AccID='" & Request("AccountID") & "' and GrpTempID='" & Request("GrpTempID") & "'"
            ...
            For i = 0 To ListBox2.Items.Count - 1
                SQLSTR = "Insert Into AdminSecureweb.dbo.tblAssignTemplates (AccID, GrpTempID, TemplateID, DateUpdated) Values ('" & Request("AccountID") & "','" & Request("GrpTempID") & "','" & ListBox2.Items(i).Value & "','" & Now & "')"
        ...
        Catch ex As Exception
            Label1.Text = Err.Description.ToString
        End Try
    End Sub
End Class
