...
Partial Class UserPhyAssgn_Default
    ...
    Protected Sub BtnAssign_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles BtnAssign.Click
        ...
        For j = 1 To HLoc.Value
            ...
            'End If
        Next
        Dim clsLevel As New ETS.BL.PlatFormLevelConfg
        clsLevel.SetPlatformLevelConfg(DT, Session("ContractorID").ToString)
        DT.Dispose()
    ...
    Sub LocStatus()
        ...
        Dim clsActLoc As New ETS.BL.PlatFormLevelConfg
        With clsActLoc
            .ContractorID = Session("contractorID").ToString
            DSActLocs = .getAcountsPlatformLevelConfgList
        End With
        clsActLoc = Nothing
