<%@ Page Language="VB" AutoEventWireup="false" CodeFile="LevelConfg.aspx.vb" Inherits="UserPhyAssgn_Default" EnableViewState="True" %>
   ...
   function addRowToTable()
{
  ...
  var sel3 = document.getElementById('ProdLevel1').cloneNode(true);
  sel3.name = 'ProdLevel' + iteration;
  sel3.value='';
  ...
  var sel5 = document.getElementById('Weightage1').cloneNode(true);
  sel5.name = 'Weightage' + iteration;
  sel5.value='';
                    ...
                    <asp:Panel ID="Panel7" runat="server" Width="100%">
                        ...
                        <asp:Table ID="Table2" runat="server" Width="100%">
                            <asp:TableRow ID="TableRow3" runat="server" style="text-align: center">
                                ...
                                <asp:TableCell ID="TableCell1" CssClass="alt1" runat="server">Production Level</asp:TableCell>
                                <asp:TableCell ID="TableCell2" CssClass="alt1" runat="server">Factor</asp:TableCell>
                                <asp:TableCell ID="TableCell3" CssClass="alt1" runat="server">Weightage</asp:TableCell>
                            </asp:TableRow>
                            <asp:TableRow ID="TableRow4" runat="server">
                                ...
                                <asp:TableCell ID="TableCell9" runat="server">
                                    ...
                                    <asp:TextBox ID="ProdLevel1" runat="server"></asp:TextBox></asp:TableCell>
                                    <asp:TableCell ID="TableCell11" runat="server">
                                    <asp:TextBox ID="Factor1" runat="server"></asp:TextBox></asp:TableCell>
                                    <asp:TableCell ID="TableCell12" runat="server">
                                    <asp:TextBox ID="Weightage1" runat="server"></asp:TextBox></asp:TableCell>
                            </asp:TableRow>
                        </asp:Table>
