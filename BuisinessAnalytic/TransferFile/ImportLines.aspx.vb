...
Partial Class Billing_FileImport_ImportLines
    ...
    Protected Sub InsertRec(ByVal PlatformID As String, ByVal Username As String, ByVal JobNumber As String, ByVal Level As String, ByVal Lines As Double, ByVal Dictator As String, ByVal Postdate As Date)
        Dim strConn As String
        ...
        Try
            oConn.Open()
            strQuery = "INSERT INTO [ADMINETS].[dbo].[tblUserPlatLines] (PlatActID, Username, JobNumber, UserLevel, Lines, Dictator, PostDate,updatedate ) VALUES "
            strQuery = strQuery & " ('" & PlatformID & "' ,'" & Username & "' ,'" & JobNumber & "' ,'" & Level & "'  ,'" & Lines & "' ,'" & Dictator & "'  ,'" & Postdate & "' ,'" & Now() & "'   )"
    ...
    Protected Sub UpdateRec(ByVal Username As String, ByVal Lines As Double, ByVal Dictator As String, ByVal PostDate As Date, ByVal JobNumber As String, ByVal Level As String)
        Dim strConn As String
        Dim strQuery As String
        strConn = System.Configuration.ConfigurationManager.AppSettings("ETSCon")
        Dim oConn As New Data.SqlClient.SqlConnection(strConn)
        Try
            oConn.Open()
            strQuery = "UPDATE [ADMINETS].[dbo].[tblUserPlatLines]  SET Username = '" & Username & "' ,Lines = '" & Lines & "' ,Dictator =  '" & Dictator & "', updatedate = '" & Now & "' WHERE JobNumber = '" & JobNumber & "' and userLevel  = '" & Level & "'"
    ...
    Protected Sub ShowDetails(ByVal Platform As String, ByVal Username As String, ByVal JobNumber As String, ByVal Level As String, ByVal Lines As Double, ByVal Dictator As String, ByVal PostDate As Date, ByVal recstatus As String)
    ...
    Protected Sub Button1_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles Button1.Click
        ...
        Dim cmd As New OleDbCommand("Select {" & DLPlatform.SelectedValue & "} as [PlatActID],[UserLevel], [JobNumber],[PostDate],[Lines],[Username],[Dictator], '" & Now & "' as [updatedate]  from [Sheet1$]", excelConnection)
