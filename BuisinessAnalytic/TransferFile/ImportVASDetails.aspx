<%@ Page Language="VB" AutoEventWireup="false" CodeFile="ImportVASDetails.aspx.vb" Inherits="ImportInvoice" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <asp:TableCell CssClass="alt1">Item</asp:TableCell> 
        <asp:TableCell CssClass="alt1">Description</asp:TableCell> 
        <asp:TableCell CssClass="alt1">DATE</asp:TableCell> 
        <asp:TableCell CssClass="alt1">Qty</asp:TableCell> 
        <asp:TableCell CssClass="alt1">AMOUNT</asp:TableCell> 
        <asp:TableCell CssClass="alt1">Total</asp:TableCell> 
        ...
        <br />
         <a href="Import VAS - MM DD YYYY.xls"><span style="color: #ff0000;" class="common">
