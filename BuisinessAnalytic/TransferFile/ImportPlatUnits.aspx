<%@ Page Language="VB" AutoEventWireup="false" CodeFile="ImportPlatUnits.aspx.vb" Inherits="Login_CreateUser" %>
...
<body>
    ...
    <div>
       <table width="100%">
            <tr>
                <td colspan="5" style="background-image:url('../../../images/demographics.jpg'); height:30px; text-align: left">
                    <span style="font-size: 8pt; font-family: Arial"><strong>Import Platform Units<span
                        style="font-size: 8pt"><span style="font-family: Arial">&nbsp;</span></span></strong></span></td>
            </tr>
            </table>  
               
               <table   id="Table1" style="font-size: 8pt; font-family: 'Arial';  " border ="2" cellpadding ="2" cellspacing ="2">
        <tr class="tblbgbody">
                <td style="text-align: left;"  valign="top" >
                    <span style="font-family: Arial; color: white;"><strong>Group Platform</strong></span></td>
                        <td style="text-align: left;" class="SMSelected" valign="top" >
                    <span style="font-family: Arial; color: white;">
                        <asp:DropDownList ID="DLPlatform" runat="server" AutoPostBack="true" Font-Names="Arial" Font-Size="8">
      ...
      <asp:TableCell>MTUnits</asp:TableCell>
<asp:TableCell>MTRate</asp:TableCell>
<asp:TableCell>MTPUnits</asp:TableCell>
<asp:TableCell>MTPRate</asp:TableCell>
<asp:TableCell>QAUnits</asp:TableCell>
<asp:TableCell>QARate</asp:TableCell>
<asp:TableCell>MTSUnits</asp:TableCell>
<asp:TableCell>MTSRate</asp:TableCell>
<asp:TableCell>MTPSRate</asp:TableCell>
<asp:TableCell>QASUnits</asp:TableCell>
<asp:TableCell>QASRate</asp:TableCell>
<asp:TableCell>CPL</asp:TableCell>
<asp:TableCell>STATUnits</asp:TableCell>
<asp:TableCell>BillCycle</asp:TableCell>
<asp:TableCell>BillMonth</asp:TableCell>
<asp:TableCell>BillYear</asp:TableCell>
