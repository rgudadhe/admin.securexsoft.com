<%@ Page Language="VB" AutoEventWireup="false" CodeFile="ViewVASDetails.aspx.vb" Inherits="Billing_LCMethods_LCMethodology" %>
...
<asp:ScriptManager ID="SCRIPTMANAGER1" runat="server"  ></asp:ScriptManager>      
   ...
   <table width="100%">
            <tr>
                <td colspan="5" style="background-image:url('../../../images/demographics.jpg'); height:30px">
                    <span style="font-size: 8pt; font-family: Arial"><strong>View VAS Details<span
           ...
           <table width="400" border="2" cellpadding="2" cellspacing="2"   >
             <tr class="tblbg">
                <td colspan="2" style="text-align: center" >
                    <span style="font-size: 8pt; font-family: Arial"><strong>View Account VAS Details</strong></span>
     ...
     <ajaxToolkit:CollapsiblePanelExtender ID="cpeDemo" runat="Server"
        ...
        /> 
                    ...
                    <asp:Label ID="lblDisp" runat="server" Font-Bold="True"   Font-Names="Arial" Font-Size="8" ForeColor="#C00000"></asp:Label>&nbsp;
                      ...
                      <asp:CompleteGridView ID="MyDataGrid" runat="server" CellPadding="2" AllowSorting="True" 
                    Font-Names="Arial"   
                    Font-Size="8" EnableViewState="False"  
                    Width="100%" CellSpacing="2" PageSize="25" CountFormat="Displaying records <b>{0}</b> to <b>{1}</b> from <b>{2}</b>" Font-Italic="False" CaptionAlign="Bottom" ShowCount="True" AutoGenerateDeleteButton="True" AutoGenerateEditButton="True" SortAscendingImageUrl="" SortDescendingImageUrl="" AutoGenerateColumns="False" ShowInsertRow="True"  >
