<%@ Page Language="VB" AutoEventWireup="false" CodeFile="VASDetails.aspx.vb" Inherits="Billing_LCMethods_LCMethodology" %>
    ...
    <form id="form1" runat="server">
        ...
        <asp:Panel ID="Panel1" runat="server" HorizontalAlign="Left">
            <div>
                    ...
                    PageSize="25" CountFormat="Displaying records <b>{0}</b> to <b>{1}</b> of <b>{2}</b>" CaptionAlign="Bottom" AutoGenerateEditButton="True"  AutoGenerateColumns="False" ShowInsertRow="True" ShowFilter="false"  >
                ...
                <PagerSettings PreviousPageText="Previous" PageButtonCount="25" Mode="NumericFirstLast" LastPageText="Last Page" FirstPageText="First Page" NextPageText="Next Page"></PagerSettings>
                          ...
                          <Columns>
                              ...
                              <asp:BoundField DataField="Item"   HeaderText="Item" SortExpression="Item" HeaderStyle-CssClass="alt1" />
                              <asp:BoundField DataField="Description"  HeaderText="Description" SortExpression="Description" HeaderStyle-CssClass="alt1" />
      ...
      <%--  <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:SecureWebConnectionString %>"
            ...
            updatecommand="UPDATE ITEMDETAILS SET ITEM=@Item, Description=@Description, Rate=@Rate, mode=@mode where itemid=@itemid"
          
            Insertcommand="Insert Into ITEMDETAILS (ITEM, Description, Rate, mode) Values  (@Item, @Description, @Rate, @mode)"
            >
        </asp:SqlDataSource>--%>
    </div>
        </asp:Panel>
