<%@ Page Language="VB" AutoEventWireup="false" CodeFile="UsersIDMappings.aspx.vb" Inherits="Billing_LCMethods_LCMethodology" %>
            ...
            <div>
                ...
                <PagerSettings PreviousPageText="Previous" PageButtonCount="25" Mode="NumericFirstLast" LastPageText="Last Page" FirstPageText="First Page" NextPageText="Next Page"></PagerSettings>
                          ...
                          <%--<asp:TemplateField HeaderText="User Name" HeaderStyle-CssClass="alt1">
                           <ItemTemplate>                    <asp:Label ID="lblLevel" runat="server" Text='<%# Eval("uname") %>' />  
                                       </ItemTemplate>   
                                                  
                                       </asp:TemplateField> --%>
                          
                              <%--<asp:BoundField DataField="uname"   HeaderText="Name" SortExpression="uname" HeaderStyle-CssClass="alt1" />--%>
                              <asp:BoundField DataField="MTID"   HeaderText="MTID" SortExpression="MTID" HeaderStyle-CssClass="alt1" />
                              <asp:BoundField DataField="QAID"  HeaderText="QAID" SortExpression="QAID" HeaderStyle-CssClass="alt1" />
                              <asp:BoundField DataField="QABID" HeaderText="QABID"  SortExpression="QABID" HeaderStyle-CssClass="alt1" >
