<%@ Page Language="VB" AutoEventWireup="false" CodeFile="ShowPhysiciansLinesDetails.aspx.vb" Inherits="BuisinessAnalytic_Configuration_Default" %>
...
<body  >
    ...
    <div id="cap"></div>
    <div id="main">
    <h1>Show all Physicians details </h1>
        <div style="text-align:left">
         <a href="PhysiciansLinesDeductions_New.aspx">Physicians Units Deductions</a>
        <br />
            ...
            <tr>
             ...
             <tr> 
                ...
                <PagerSettings PreviousPageText="Previous" PageButtonCount="25" Mode="NumericFirstLast" LastPageText="Last Page" FirstPageText="First Page" NextPageText="Next Page"></PagerSettings>
                          ...
                          <Columns>
                          <asp:TemplateField HeaderText="Account" HeaderStyle-CssClass="alt1">
                           <ItemTemplate>                    <asp:Label ID="lblAName" runat="server" Text='<%# Eval("AccountName") %>' />  
                                       </ItemTemplate>   
                                                  
                                       </asp:TemplateField> 
                                       <asp:TemplateField HeaderText="Dictator" HeaderStyle-CssClass="alt1">
