<%@ Page Language="VB" AutoEventWireup="false" CodeFile="UsersCostMonthly.aspx.vb" Inherits="Billing_LCMethods_LCMethodology" %>
      ...
      <table width="500">
            ...
            <tr >
                 <td style="text-align: center" width="30%" >
                     ...
                     <asp:DropDownList ID="DLMonth" AutoPostBack="true"  runat="server" CssClass="common">
                ...
                <td style="text-align: center" width="30%">
                        ...
                        <asp:DropDownList AutoPostBack="true"   ID="DLYear" runat="server" CssClass="common">
