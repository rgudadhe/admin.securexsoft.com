...
Partial Class Billing_LCMethods_LCMethodology
    ...
    Protected Sub BindData()
        Dim obj As New ETS.BL.UserstargetsMonthly
        With obj
            '.contractorid = Session("contractorid").ToString
            .ProcMonth = DLMonth.SelectedValue
            .ProcYear = DLYear.SelectedValue
        End With
        'obj._WhereString = " Order by uname "
        Dim DTSet As System.Data.DataSet = obj.getTargetsMonthlyDetails
