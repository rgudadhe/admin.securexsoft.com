...
Partial Class EditUser
    ...
    Sub ShowData()
        ...
        Dim clsUsr As ETS.BL.TemplatesLinesDeductions
        Try
            clsUsr = New ETS.BL.TemplatesLinesDeductions
            clsUsr.TemplateID = Request("DLAct").ToString
            'Response.Write(" WHERE TemplateID = '" & Request("DLAct").ToString & "'")

            Dim DS As DataSet = clsUsr.gettblTemplatesLinesDeductionsList
    ...
    Protected Sub Button4_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles Button4.Click
        ...
        Dim obj As New ETS.BL.TemplatesLinesDeductions

        Dim RowAffected As Integer
        With obj
            obj.TemplateID = DLAct.SelectedValue
            obj.DeletetblTemplatesLinesDeductions(oConn, thisTransaction)
            RowAffected = obj.InserttblTemplatesLinesDeductions(oConn, thisTransaction, "[TemplateID],[Mode],[Value],[updatedate]", "'" & DLAct.SelectedValue & "', '" & DLMode.SelectedValue & "','" & TXTValue.Text & "','" & Now & "'")
    ...
    Protected Sub BindData()
        ...
        Try
            oConn.Open()
            SQLString = "SF_gettemplatesLinesDeductions"
