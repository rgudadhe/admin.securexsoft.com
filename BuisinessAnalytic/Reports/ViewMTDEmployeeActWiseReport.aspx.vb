...
Partial Class ViewUnitsTrend
    ...
    Protected Sub ShowActDetails()
        ...
        Dim DTSet2 As System.Data.DataSet = objrep.GetEMPMTDAccountWiseReport(New Guid(Session("contractorID").ToString), CurrSDate, InpDate, Session("WorkGroupId").ToString)
    ...
    Protected Sub AttachColumn()
        Dim PerColumn As Integer = MyDataGrid.Columns.Count - 4
