<%@ Page Language="VB"  AutoEventWireup="false" CodeFile="ViewProductivitychart.aspx.vb" Inherits="ViewUnitsTrend" %>
            ...
            <tr >
                ...
                <td style="text-align: center" >
                        ...
                        <asp:DropDownList ID="DLTrend" runat="server" CssClass="common">
                           ...
                           <asp:ListItem Text="Points" Selected="True"   Value="Points"></asp:ListItem>  
                           </asp:DropDownList>
                </td>
