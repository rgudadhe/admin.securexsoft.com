...
Partial Class ViewUnitsTrend
    ...
    Protected Sub ShowActDetails()
        ...
        End If
        DayDiff = DateDiff(DateInterval.Day, startdate, EndDate)
        Dim DTSet2 As System.Data.DataSet = objrep.GetCustomerBillingByPhyID(New Guid(Session("ContractorId").ToString), DayDiff, EndDate, New Guid(DLAct.SelectedValue))
    ...
    Protected Sub Button1_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles Button1.Click
        ...
        filename = "Dictator Activity " & Month(Now) & Day(Now) & Year(Now) & ".xls"
