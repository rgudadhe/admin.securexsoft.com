...
Partial Class ViewUnitsTrend
    ...
    Protected Sub ShowActDetails()
        ...
        End If
        If IsDate(TXTEDate.Text) Then
            EndDate = TXTEDate.Text
        End If

        DayDiff = DateDiff(DateInterval.Day, startdate, EndDate)
        
        Dim DTSet2 As System.Data.DataSet = objrep.GetCustomerBilling(New Guid(Session("ContractorId").ToString), DayDiff, EndDate, Nothing)
    ...
    Protected Sub Button1_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles Button1.Click
        ...
        filename = "Customer Activity " & Month(Now) & Day(Now) & Year(Now) & ".xls"
