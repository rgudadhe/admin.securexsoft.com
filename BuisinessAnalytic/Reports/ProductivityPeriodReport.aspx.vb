...
Partial Class DailyTeamReport
    ...
    Protected Sub ShowActDetails()
        ...
        If DLGroup.SelectedValue = "Platform" Then
            DTSet2 = objrep.GetProductivityReportOrderbyPLT(New Guid(Session("contractorID").ToString), DayDiff, InpDate)
        Else
            DTSet2 = objrep.GetProductivityReportOrderbyDNAME(New Guid(Session("contractorID").ToString), DayDiff, InpDate)
        End If
