...
Partial Class ViewUnitsTrend
    ...
    Protected Sub ShowActDetails()
        ...
        Dim DTSet2 As System.Data.DataSet = objrep.GetDirectTrend(New Guid(Session("ContractorId").ToString), DayDiff, EndDate2, ParmValues, CheckBox1.Checked, CompMonth, CompYear, DLTrend.SelectedValue, session("WorkGroupId").tostring)
    ...
    Protected Sub Button1_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles Button1.Click
        ...
        filename = "Monthly Payroll Trend " & Month(Now) & Day(Now) & Year(Now) & ".xls"
