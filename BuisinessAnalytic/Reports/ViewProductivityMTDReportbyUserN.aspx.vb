...
Partial Class ViewUnitsTrend
    ...
    Protected Sub ShowActDetails()
        ...
        CurrSDate = Request("StartDate")
        CurrEDate = Request("EndDate")
        ...
        Dim DTSet2 As System.Data.DataSet = objrep.GetEMPMTDDailyProductivityReportbyUser(New Guid(Request("userid")), CurrSDate, CurrEDate)
    ...
    Protected Sub AttachColumn()
        ...
        For Each objRow As GridViewRow In MyDataGrid.Rows
            If objRow.RowIndex = 0 Then
                ...
                objRow.Cells(0).Text = "<a href='ViewProductivityJobWisebyUser.aspx?ShowAct=Yes&userid=" & Request("userid") & "&Enddate=" & CurrEDate & "&StartDate=" & CurrSDate & "'>" & objRow.Cells(0).Text & "</a>"
