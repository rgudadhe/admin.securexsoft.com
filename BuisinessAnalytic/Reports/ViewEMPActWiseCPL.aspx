<%@ Page Language="VB"  AutoEventWireup="false" CodeFile="ViewEMPActWiseCPL.aspx.vb" Inherits="MIS_DailyMins" %>
...
<body>
    <form id="BillDet" runat="server">
        ...
        <div id="cap"></div>
        <div id="main">
        <h1>View Employee AccountWise CPL</h1>
          ...
          <asp:Panel ID="Panel4" runat="server" width="100%">
           <table width="500">
            ...
            <td style="text-align: center" width="30%" >
                ...
                <asp:DropDownList ID="DLUser" runat="server" CssClass="common"    >
