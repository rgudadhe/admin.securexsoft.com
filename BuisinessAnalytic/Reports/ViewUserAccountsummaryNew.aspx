<%@ Page Language="VB"  AutoEventWireup="false" CodeFile="ViewUserAccountsummaryNew.aspx.vb" Inherits="ViewUnitsTrend" %>
...
<body>
    <form id="BillDet" runat="server">
        ...
        <div id="cap"></div>
        <div id="main">
        <h1>User - Accountwise Details  </h1>
            ...
            <tr >
                <td style="text-align: left; "  class="HeaderDiv" >
                 ...
                 <td style="text-align: left; "  class="HeaderDiv" >
                   ...
                   <asp:TextBox ID="TxtSDate" Width="80px"  runat="server" ></asp:TextBox>
                ...
                <td style="text-align: left; "  class="HeaderDiv" >
                        ...
                        <asp:TextBox ID="TxtEDate" Width="80px" runat="server" ></asp:TextBox>
                ...
                <td style="text-align: left; "   class="HeaderDiv" >
                    ...
                    <asp:DropDownList ID="DLUnits"  runat="server" Width="80px" AutoPostBack="false">
                    <asp:ListItem Text="Lines" Value="Lines"></asp:ListItem>
                    <asp:ListItem Text="Mins" Value="Mins"></asp:ListItem>
                    </asp:DropDownList>
                </td>
