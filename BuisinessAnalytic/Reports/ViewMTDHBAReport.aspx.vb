...
Partial Class ViewUnitsTrend
    ...
    Protected Sub ShowActDetails()
        ...
        Dim DTSet2 As System.Data.DataSet = objrep.GetMTDHBAProductivityReport(New Guid(Session("ContractorID").ToString), CurrSDate, InpDate, session("WorkGroupId").tostring)
    ...
    Protected Sub AttachColumn()
        For Each objRow As GridViewRow In MyDataGrid.Rows
            If objRow.RowIndex = 0 Then
                ...
                objRow.Cells(MyDataGrid.Columns.Count - 1).Text = String.Empty
            Else
                'objRow.Font.Bold = True
                ...
                objRow.Cells(MyDataGrid.Columns.Count - 1).Text = objRow.Cells(MyDataGrid.Columns.Count - 1).Text & " %"
            End If
        Next
        'Dim dt As Date
