...
Partial Class ViewUnitsTrend
        ...
        If DTSet2.Tables.Count > 0 Then
            If DTSet2.Tables(0).Rows.Count > 0 Then
                ...
                For I As Integer = 0 To DTSet2.Tables(0).Rows.Count - 1
                    ...
                    If lngUnits = 0 Then
                        DTSet2.Tables(0).Rows(I).Item(5) = 0
                        DTSet2.Tables(0).Rows(I).Item(6) = 0
                    Else
                        DTSet2.Tables(0).Rows(I).Item(5) = FormatNumber((lngRevenue / lngUnits), 3)
                        DTSet2.Tables(0).Rows(I).Item(6) = FormatNumber((lngCost / lngUnits), 3)
                    End If

                    DTSet2.Tables(0).Rows(I).Item(7) = FormatNumber(100 - ((lngCost / lngRevenue) * 100), 0)
                Next
    ...
    Protected Sub AttachColumn()
        For Each objRow As GridViewRow In MyDataGrid.Rows
            ...
            Else
                If objRow.Cells(0).Text = "11111111-1111-1111-1111-111111111111" And objRow.Cells(1).Text = "VAS" Then
                    objRow.Cells(1).Text = "<a href='ViewVasReport.aspx?ShowAct=Yes&DLMonth1=" & DLMonth1.SelectedValue & "&DLYear1=" & DLYear1.SelectedValue & "'>" & objRow.Cells(1).Text & "</a>"
                ElseIf objRow.Cells(0).Text = "11111111-1111-1111-1111-111111111111" Then
