<%@ Page Language="VB"  AutoEventWireup="false" CodeFile="DeletePlatBillingUnitsReport.aspx.vb" Inherits="ViewPlatBillingUnitsReport" %>
        ...
        /> --%>
         ...
         <br />
            <br />
             ...
             <asp:TableHeaderCell ID="TableHeaderCell3" Text="65 CPL Units"></asp:TableHeaderCell>
              <asp:TableHeaderCell ID="TableHeaderCell7" Text="Billing Units"></asp:TableHeaderCell>
