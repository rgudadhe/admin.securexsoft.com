...
Partial Class ViewUnitsTrend
    ...
    Protected Sub ShowActDetails()
        ...
        Dim DTSet2 As System.Data.DataSet = objrep.GetEMPMTDProductivityReportbyUser(New Guid(Session("UserID").ToString), CurrSDate, CurrEDate)
    ...
    Protected Sub AttachColumn()
        ...
        For Each objRow As GridViewRow In MyDataGrid.Rows
            ...
            objRow.Cells(1).Text = "<a href='ViewProductivityMTDReportbyUserN.aspx?userid=" & objRow.Cells(0).Text & "&StartDate=" & TxtSDate.Text & "&EndDate=" & TxtEDate.Text & "'>" & objRow.Cells(1).Text & "</a>"
