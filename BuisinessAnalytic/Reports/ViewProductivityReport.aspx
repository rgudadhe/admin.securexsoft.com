<%@ Page Language="VB" AutoEventWireup="false" CodeFile="ViewProductivityReport.aspx.vb" Inherits="DailyTeamReport" %>
...
{
    //url="SimPatRecords.aspx?transid="+ document.frmReports.hCReptID.value;
	newwindow=window.open(url,'ViewDetails',"width=600,height=500, top=100, left=100, scrollbars=1,menubar=0,toolbar=0,location=0,status=0");
...
<body>
    <form id="form1" runat="server">
        ...
        <div id="cap"></div>
        <div id="main">
        <h1>View Productivity Report</h1>
     ...
     <ajaxToolkit:CollapsiblePanelExtender ID="cpeDemo" runat="Server"
       ...
       <div style="text-align:center " >
        ...
        <asp:TableRow ID="TableRow1" runat="server" HorizontalAlign="Center"         >
                <asp:TableCell runat="server" ID="tblDtls"  CssClass="HeaderDiv" ColumnSpan="13"    >SecureXFlow</asp:TableCell>
                </asp:TableRow>
               <asp:TableRow ID="TableRow3" runat="server" HorizontalAlign="Center"        >
                <asp:TableCell runat="server" ID="TableCell9"  CssClass="alt1" ColumnSpan="13"     >Productivity Report</asp:TableCell>
                </asp:TableRow>
               <asp:TableRow ID="TableRow4" runat="server" HorizontalAlign="Center"      Font-Size="Smaller"     >
                <asp:TableCell runat="server" ID="TableCell10"  CssClass="HeaderDiv" ColumnSpan="13"    >
            ...
            <asp:TableRow ID="TableRow2" runat="server" HorizontalAlign="Center"    >
                ...
                <asp:TableCell ColumnSpan="10"  runat="server" ID="R1Cell3" HorizontalAlign="Center" CssClass="HeaderDiv" >Month To Date Lines</asp:TableCell>
