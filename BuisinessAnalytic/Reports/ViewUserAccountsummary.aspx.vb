...
Partial Class ViewUnitsTrend
    ...
    Protected Sub ShowActDetails()
        ...
        Dim DTSet2 As System.Data.DataSet = objrep.GetInstProductivityReportbyUser(New Guid(DLUser.SelectedValue), DLMonth1.SelectedValue, DLYear1.SelectedValue, session("WorkGroupID").Tostring)
