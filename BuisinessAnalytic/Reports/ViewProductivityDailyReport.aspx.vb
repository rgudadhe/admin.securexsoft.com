...
Partial Class ViewUnitsTrend
    ...
    Protected Sub ShowActDetails()
        ...
        Dim DTSet2 As System.Data.DataSet = objrep.GetProductivityDailyReportbyUser(New Guid(DLUser.SelectedValue), DLMonth1.SelectedValue, DLYear1.SelectedValue)
    ...
    Protected Sub AttachColumn()
        ...
        If Month(Now) = DLMonth1.SelectedValue And Year(Now) = DLYear1.SelectedValue Then
            EndDate = Now.ToShortDateString
            startdate = Month(EndDate) & "/01/" & Year(EndDate)
        Else
        ...
        For Each objRow As GridViewRow In MyDataGrid.Rows
            If objRow.RowIndex = 0 Then
                ...
                objRow.Cells(0).Text = "<a href='ViewProductivityJobWisebyUser.aspx?ShowAct=Yes&userid=" & Request("userid") & "&Enddate=" & EndDate & "&StartDate=" & startdate & "'>" & objRow.Cells(0).Text & "</a>"
            Else
    ...
    Protected Sub Button1_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles Button1.Click
        ...
        filename = "Payroll Summary " & Month(Now) & Day(Now) & Year(Now) & ".xls"
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        If Not IsPostBack Then
            ...
            If Request("ShowAct") = "Yes" Then
                ...
                For I As Integer = 0 To DLUser.Items.Count - 1
                    If DLUser.Items(I).Value = Request("UserID") Then
                        DLUser.Items(I).Selected = True
                    End If
                Next
                For I As Integer = 0 To DLMonth1.Items.Count - 1
                    If DLMonth1.Items(I).Value = Request("Month") Then
                        DLMonth1.Items(I).Selected = True
                    End If
                Next
                For I As Integer = 0 To DLYear1.Items.Count - 1
                    If DLYear1.Items(I).Value = Request("Year") Then
