...
Partial Class ViewUnitsTrend
    ...
    Protected Sub ShowActDetails()
        ...
        Dim DTSet2 As System.Data.DataSet = objrep.GetHBAPayrollSummary(New Guid(Session("ContractorId").ToString), DLMonth1.SelectedValue, DLYear1.SelectedValue)
    ...
    Protected Sub Button1_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles Button1.Click
        ...
        filename = "contractor Payroll " & Month(Now) & Day(Now) & Year(Now) & ".xls"
