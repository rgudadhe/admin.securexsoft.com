<%@ Page Language="VB" EnableEventValidation="False" ViewStateEncryptionMode="Never"    AutoEventWireup="false"   CodeFile="PostDetails.aspx.vb" Inherits="MIS_DailyMins" %>
...
{
alert(document.BillDet.chBillAccID.value);
