...
Partial Class ViewUnitsTrend
    ...
    Protected Sub ShowActDetails()
        ...
        'Response.Write(EndDate & "#" & DayDiff & "#" & DLAct.SelectedValue)
        'Response.End()

        Dim DTSet2 As System.Data.DataSet = objrep.GetSSFDictatorWiseCPL(DayDiff, EndDate, New Guid(DLAct.SelectedValue))
        'Response.End()
    ...
    Protected Sub Button1_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles Button1.Click
        ...
        filename = "Dictatorwise CPL " & Month(Now) & Day(Now) & Year(Now) & ".xls"
