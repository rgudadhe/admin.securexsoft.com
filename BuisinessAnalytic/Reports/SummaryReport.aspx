<%@ Page Language="VB" AutoEventWireup="false" CodeFile="SummaryReport.aspx.vb" Inherits="MIS_DailyMins" %>
     ...
     <ajaxToolkit:CollapsiblePanelExtender ID="cpeDemo" runat="Server"
        ...
        <asp:TableRow  >
               ...
               <%-- <asp:TableCell runat="server" ID="R1Cell2" >Number Of Jobs</asp:TableCell>
                ...
                <asp:TableCell runat="server" ID="TableCell1" CssClass="alt1">Units</asp:TableCell> 
            </asp:TableRow>
