...
Partial Class ViewUnitsTrend
    ...
    Protected Sub ShowActDetails()
        ...
        Dim DTSet2 As System.Data.DataSet = objrep.GetProductivityPeriodReportForAll(New Guid(Session("ContractorId").ToString), DayDiff, InpEDate, Session("WorkGroupId").ToString)
