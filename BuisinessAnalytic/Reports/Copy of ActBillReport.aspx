<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Copy of ActBillReport.aspx.vb" Inherits="MIS_DailyMins" %>
...
<body style="text-align: center">
 ...
 <asp:Table ID="tblReports" runat="server" Font-Bold="False" Font-Italic="False" Font-Names="Arial" Font-Size="8"  Width="100%" BorderColor="Silver" GridUnits="both"  HorizontalAlign="Center" CssClass="tblbg" >
                ...
                <asp:TableCell runat="server" ID="TableCell6"  ColumnSpan="7"  >JobWise Details (<asp:Label ID="lblDict" runat="server" CssClass="tblbgbody" ForeColor = "White" Font-Size="8"  ></asp:Label>)</asp:TableCell>
                </asp:TableRow>
            <asp:TableRow ID="TableRow5" runat="server" HorizontalAlign="Center" CssClass="tblbg"  >
               ...
               <asp:TableCell runat="server" ID="TableCell10">E-Dictate Job#</asp:TableCell> 
               <asp:TableCell runat="server" ID="TableCell11">Your Job#</asp:TableCell>
               <asp:TableCell runat="server" ID="TableCell15">Template</asp:TableCell> 
