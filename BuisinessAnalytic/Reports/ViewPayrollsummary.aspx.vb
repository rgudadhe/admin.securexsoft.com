...
Partial Class ViewUnitsTrend
    ...
    Protected Sub ShowActDetails()
        ...
        Dim DTSet2 As System.Data.DataSet = objrep.GetPayrollSummary(New Guid(Session("ContractorId").ToString), DLMonth1.SelectedValue, DLYear1.SelectedValue)
    ...
    Protected Sub AttachColumn()
        For Each objRow As GridViewRow In MyDataGrid.Rows
            ...
            Else
                ...
                objRow.Cells(1).Text = "<a href='ViewProductivityDailyReport.aspx?ShowAct=Yes&Month=" & DLMonth1.SelectedValue & "&Year=" & DLYear1.SelectedValue & "&UserID=" & objRow.Cells(0).Text & "'>" & objRow.Cells(1).Text & "</a>"
