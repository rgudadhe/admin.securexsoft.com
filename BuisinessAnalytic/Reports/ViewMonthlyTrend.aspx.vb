...
Partial Class ViewUnitsTrend
    ...
    Protected Sub ShowActDetails()
        ...
        Dim DTSet2 As System.Data.DataSet = objrep.GetMonthlyTrends(New Guid(Session("ContractorId").ToString), DayDiff, EndDate2, Nothing, ParmValues, CheckBox1.Checked, CompMonth, CompYear, DLTrend.SelectedValue)
