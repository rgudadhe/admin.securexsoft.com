<%@ Page Language="VB"  AutoEventWireup="false" CodeFile="ViewHBAPayrollReport.aspx.vb" Inherits="MIS_DailyMins" %>
...
<title>HBA Payroll Report</title>
</head>
<body>
        ...
        <asp:Panel ID="Panel1" runat="server" HorizontalAlign="center">
            <asp:Table ID="tblMins" runat="server" >
                ...
                <asp:TableRow ID="TableRow1" runat="server" HorizontalAlign="Left">
                    <asp:TableCell runat="server" CssClass="alt1" horizontalAlign="Center" ID="TableCell7" >HBA Name</asp:TableCell>
                    ...
                    <asp:TableCell runat="server" CssClass="alt1" horizontalAlign="Center" ID="TableCell6" >Cost</asp:TableCell>
                </asp:TableRow>
