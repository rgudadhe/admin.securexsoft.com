...
Partial Class ViewUnitsTrend
    ...
    Protected Sub ShowActDetails()
        ...
        Dim DTSet2 As System.Data.DataSet = objrep.GetInstProductivityReportbyUserNew(New Guid(DLUser.SelectedValue), TxtSDate.Text, TxtEDate.Text, Session("WorkGroupID").ToString, DLUnits.SelectedValue)

        DTSet2.WriteXml("D:\report.xml")
        If DTSet2.Tables.Count > 0 Then
            If DTSet2.Tables(0).Rows.Count > 0 Then
                ...
                For I As Integer = 0 To DTSet2.Tables(0).Rows.Count - 1
                    ClmCount = 0
                    For j As Integer = 3 To DTSet2.Tables(0).Columns.Count - 1
                        'ClmCount += 1
                        If I = 0 Then
    ...
    Protected Sub AttachColumn()
        ...
        MyDataGrid.Columns(MyDataGrid.Columns.Count - 1).Visible = False
        MyDataGrid.Columns(MyDataGrid.Columns.Count - 2).Visible = False
        MyDataGrid.Columns(MyDataGrid.Columns.Count - 3).Visible = False
        'MyDataGrid.Columns(MyDataGrid.Columns.Count - 4).Visible = False
