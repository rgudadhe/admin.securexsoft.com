<%@ Page Language="VB"  AutoEventWireup="false" CodeFile="ViewMonthlyDictatorTrend.aspx.vb" Inherits="ViewUnitsTrend" %>
        ...
        <h1>Dictator - Monthly Trend</h1>
          ...
          <asp:Panel ID="Panel4"  HorizontalAlign="Left" runat="server" width="100%">
                ...
                <td style="text-align: center" >
                        ...
                        <asp:DropDownList ID="DLTrend" runat="server" CssClass="common">
                           ...
                           <asp:ListItem Text="Minutes" Value="Minutes"></asp:ListItem> 
                            <asp:ListItem Text="Reports" Value="Jobs"></asp:ListItem> 
           ...
           <asp:Panel ID="Panel3" runat="server" width="100%">
                      ...
                      <table width="800">
            <tr >
                 <td style="text-align: Left" colspan="6"   class="alt1">
                 <table width="100%" border="1"><tr>
                 <td colspan ="6" style="text-align: Left" ><asp:CheckBox ID="CheckBox1" Text="Compare with"  runat="server" />
                ...
                <tr><td colspan="6" style="text-align: Left" >Show Changes in <asp:CheckBox ID="CheckBox2" Text="Difference"  runat="server" /><asp:CheckBox ID="CheckBox3" Text="Percentage"  runat="server" /></td></tr>
                <tr><td colspan="6" style="text-align: Left" ><asp:CheckBox ID="CheckBox4" Text="Show negative values in parentheses"  runat="server" /></td></tr></table>
