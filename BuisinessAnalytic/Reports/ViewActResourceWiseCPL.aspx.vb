...
Partial Class ViewUnitsTrend
        ...
        If DTSet2.Tables.Count > 0 Then
            If DTSet2.Tables(0).Rows.Count > 0 Then
                ...
                For I As Integer = 0 To DTSet2.Tables(0).Rows.Count - 1
                    ...
                    '    lngRevenue = DTSet2.Tables(0).Rows(I).Item(3).ToString
                    'Else
                    '    lngRevenue = 0
                    'End If
                    If IsNumeric(DTSet2.Tables(0).Rows(I).Item("Units").ToString) Then
                        lngUnits = DTSet2.Tables(0).Rows(I).Item("Units").ToString
                    Else
                        lngUnits = 0
                    End If
                    If IsNumeric(DTSet2.Tables(0).Rows(I).Item("Cost").ToString) Then
                        lngCost = DTSet2.Tables(0).Rows(I).Item("Cost").ToString
                    Else
                        lngCost = 0
                    End If
                    ''Response.Write(lngRevenue & "/" & lngUnits)
                    'DTSet2.Tables(0).Rows(I).Item(5) = FormatNumber((lngRevenue / lngUnits), 3)
                    DTSet2.Tables(0).Rows(I).Item("CPL") = FormatNumber((lngCost / lngUnits), 3)
                    'DTSet2.Tables(0).Rows(I).Item(7) = FormatNumber(100 - ((lngCost / lngRevenue) * 100))
                Next
        ...
        If Not IsPostBack Then
            ...
            If DTSet1.Tables.Count > 0 Then
                ...
                With dv
                    ...
                    .AllowEdit = True
                    .AllowNew = True
                    .RowFilter = "(Indirect='False' OR Indirect Is NULL) and contractorid ='" & Session("contractorid").ToString & "' "
    ...
    Protected Sub Button1_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles Button1.Click
        ...
        filename = "Account Resourcewise CPL " & Month(Now) & Day(Now) & Year(Now) & ".xls"
