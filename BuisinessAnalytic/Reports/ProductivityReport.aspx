<%@ Page Language="VB" AutoEventWireup="false" CodeFile="ProductivityReport.aspx.vb" Inherits="DailyTeamReport" %>
...
<body>
    <form id="form1" runat="server">
           ...
           <table width="100%" >
            ...
            <tr class="tblbg2">
                ...
                <td style="text-align: center"  class="common">
                        ...
                        Users:<asp:DropDownList ID="DLUsers" runat="server">
     ...
     <ajaxToolkit:CollapsiblePanelExtender ID="cpeDemo" runat="Server"
        ...
        <asp:Table ID="tblMins" runat="server" Width="105%"   >
        <asp:TableRow ID="TableRow1" runat="server" HorizontalAlign="Center"         >
               ...
               <asp:TableRow ID="TableRow4" runat="server" HorizontalAlign="Center"      Font-Size="Smaller"     >
                <asp:TableCell runat="server" ID="TableCell10"  CssClass="HeaderDiv" ColumnSpan="25"    >
                    <asp:Label ID="Lbldate" runat="server" Text="Label" ></asp:Label></asp:TableCell>
                </asp:TableRow>  
