<%@ Page Language="VB"  AutoEventWireup="false" CodeFile="ViewQuaterlyTrend.aspx.vb" Inherits="ViewUnitsTrend" %>
        ...
        <h1>Quaterly Trend</h1>
          ...
          <asp:Panel ID="Panel4"  HorizontalAlign="Left" runat="server" width="100%">
           <table width="500">
            ...
            <tr >
                 <td style="text-align: center"  >
                     ...
                     <asp:DropDownList ID="DLQuarter1" runat="server" CssClass="common">
                 <asp:ListItem Text="Quarter1" Value="1"></asp:ListItem> 
                 <asp:ListItem Text="Quarter2" Value="4"></asp:ListItem> 
                 <asp:ListItem Text="Quarter3" Value="7"></asp:ListItem> 
                 <asp:ListItem Text="Quarter4" Value="10"></asp:ListItem> 
                                         </asp:DropDownList>
                 </td>
                <td style="text-align: center" >
                ...
                <td style="text-align: center"  >
                     ...
                     <asp:DropDownList ID="DLQuarter2" runat="server" CssClass="common">
                 <asp:ListItem Text="Quarter1" Value="1"></asp:ListItem> 
                 <asp:ListItem Text="Quarter2" Value="4"></asp:ListItem> 
                 <asp:ListItem Text="Quarter3" Value="7"></asp:ListItem> 
                 <asp:ListItem Text="Quarter4" Value="10"></asp:ListItem>                      </asp:DropDownList>
                 </td>
                <td style="text-align: center" >
           ...
           <asp:Panel ID="Panel3" runat="server" width="100%">
                      ...
                      <table width="500">
            <tr >
                 <td style="text-align: Left" colspan="5"   class="alt1">
                 <table width="100%" border="1"><tr>
                 <td colspan ="5" style="text-align: Left" ><asp:CheckBox ID="CheckBox1" Text="Compare with"  runat="server" />
                   
                     <asp:DropDownList ID="DLQuarter" runat="server" CssClass="common">
                 <asp:ListItem Text="Quarter1" Value="1"></asp:ListItem> 
                 <asp:ListItem Text="Quarter2" Value="4"></asp:ListItem> 
                 <asp:ListItem Text="Quarter3" Value="7"></asp:ListItem> 
                 <asp:ListItem Text="Quarter4" Value="10"></asp:ListItem>                      </asp:DropDownList>
