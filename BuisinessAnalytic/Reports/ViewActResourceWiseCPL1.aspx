<%@ Page Language="VB"  AutoEventWireup="false" CodeFile="ViewActResourceWiseCPL1.aspx.vb" Inherits="MIS_DailyMins" %>
...
<body>
    <form id="BillDet" runat="server">
        ...
        <div id="cap"></div>
        <div id="main">
        <h1>View Account - ResourceWise CPL</h1>
        ...
        <asp:Panel ID="Panel1" runat="server" HorizontalAlign="center">
            <asp:Table ID="tblMins" runat="server" HorizontalAlign="center">
                ...
                <asp:TableRow ID="TableRow1" runat="server" HorizontalAlign="Left">
                    ...
                    <asp:TableCell runat="server" CssClass="alt1" horizontalAlign="Center" ID="TableCell2" >Status</asp:TableCell>
