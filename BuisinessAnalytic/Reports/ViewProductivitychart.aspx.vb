...
Partial Class ViewUnitsTrend
    ...
    Protected Sub ShowActDetails()
        ...
        Dim DTSet2 As System.Data.DataSet = objrep.GetProductivityHBAChart(New Guid(Session("ContractorId").ToString), DayDiff, EndDate2, Nothing, ParmValues, False, CompMonth, CompYear, DLTrend.SelectedValue, session("WorkGroupId").tostring)
        Dim DTSet3 As System.Data.DataSet = objrep.GetProductivityEMPChart(New Guid(Session("ContractorId").ToString), DayDiff, EndDate2, Nothing, ParmValues, False, CompMonth, CompYear, DLTrend.SelectedValue, session("WorkGroupId").tostring)

        'Response.Write(ParmValues & "#" & EndDate2 & "#" & DayDiff & "#" & Session("ContractorId").ToString)

        If DTSet2.Tables.Count > 0 And DTSet3.Tables.Count > 0 Then
            ...
            For Each dc As DataRow In DTSet3.Tables(0).Rows
                If IsDate(dc(0)) Then
                    dt1 = dc(0)
                    dc(0) = dt1.ToString("MMM yyyy")
                    'Response.Write(dc.ColumnName)
                End If

            Next
            Dim view1 As DataView = DTSet3.Tables(0).DefaultView
            ...
            ChartControl1.ChartTitle.Text = "Productivity Chart"
            ...
            If DLType.SelectedValue = "SmoothLine" Then
                ...
                If DLTrend.SelectedValue = "Units" Then
                    chart.Legend = "Contractor Units" & "(K)"
                ElseIf DLTrend.SelectedValue = "Cost" Then
                    chart.Legend = "Contractor Cost" & "(K)"
                ElseIf DLTrend.SelectedValue = "Points" Then
                    chart.Legend = "Contractor Points" & "(K)"
                End If
                chart.DataSource = view
                chart.DataXValueField = "ProcMonth"
                chart.DataYValueField = DLTrend.SelectedValue
                'If DLTrend.SelectedValue = "Units" Then
                '    chart.DataYValueField = "HBAUnits"
                'ElseIf DLTrend.SelectedValue = "Cost" Then
                '    chart.DataYValueField = "HBACost"
                'ElseIf DLTrend.SelectedValue = "Points" Then
                '    chart.DataYValueField = "HBAPoints"
                'End If
                ...
                Dim chart1 As New WebChart.SmoothLineChart
                'chart.Fill.Color = Color.CadetBlue
                'chart.MaxColumnWidth = 30
                ...
                If DLTrend.SelectedValue = "Units" Then
                    chart1.Legend = "Employee Units" & "(K)"
                ElseIf DLTrend.SelectedValue = "Cost" Then
                    chart1.Legend = "Employee Cost" & "(K)"
                ElseIf DLTrend.SelectedValue = "Points" Then
                    chart1.Legend = "Employee Points" & "(K)"
                End If
                chart1.DataSource = view1
                ...
                chart1.Shadow.Color = Color.FromArgb(70, Color.DarkGray)
            ...
            ElseIf DLType.SelectedValue = "Columnchart" Then
                ...
                chart1.MaxColumnWidth = 30
                chart1.Line.Color = Color.Red
                'chart1.Legend = DLTrend.SelectedValue & "(K)"
                If DLTrend.SelectedValue = "Units" Then
                    chart1.Legend = "Employee Units" & "(K)"
                ElseIf DLTrend.SelectedValue = "Cost" Then
                    chart1.Legend = "Employee Cost" & "(K)"
