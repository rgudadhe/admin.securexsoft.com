<%@ Page Language="VB" AutoEventWireup="false" CodeFile="ForceRouting4Phy.aspx.vb" Inherits="ForceRouting4PhyResult" %>
...
<body>
    <form id="Form1" method="post" target="ForceRouting4PhyResult" runat="server" >
    <div>
        ...
        <iframe id="ForceRouting4PhyResult" frameborder="0" name="ForceRouting4PhyResult" src="ForceRouting4PhyResult.aspx" style="width: 100%; height: 368px"
            ></iframe>    
    </div>
    </form>
</body>
