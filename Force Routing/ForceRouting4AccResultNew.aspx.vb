...
Partial Class FRAResult
    ...
    Private Sub DBind()
        ...
        If IsPostBack = False And String.IsNullOrEmpty(Request.Form("SEARCH")) = False Then
            ...
            Dim varAccNo As Integer

            If Not String.IsNullOrEmpty(Request("AName")) Then
                varAccName = Request("AName").ToString
            End If
            If Not String.IsNullOrEmpty(Request("AccNo").ToString) Then
                varAccNo = Request("AccNo").ToString()
            End If
            ...
            Try
                ...
                DS = clsCR.ForceRoutingSearchAccount(Session("ContractorID"), Session("WorkgroupID"), varAccName, varAccNo)
    ...
    Protected Sub btnSave_Click(ByVal sender As Object, ByVal e As System.EventArgs)
        ...
        Try
            ...
            Try
                clsCR = New ETS.BL.CustomRouting
                If clsCR.btn_SubmitClick_From_Account(hdnSelAccID.Value.ToString, UpdatedLevel) Then
                    iMain.Visible = True
