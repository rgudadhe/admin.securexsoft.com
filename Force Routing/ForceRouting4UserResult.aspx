<%@ Page Language="VB" AutoEventWireup="false" CodeFile="ForceRouting4UserResult.aspx.vb" Inherits="FRUResult" %>
...
<table border="1">
            ...
            <TH><div class="SMSelected">User Details</div></TH>                        
            <TH><div class="SMSelected">User Level</div></TH>                        
            </TR>
</HeaderTemplate>
...
<tr>
            <td style="font-size: 8pt; font-family: Verdana;">
            <asp:CheckBox ID="ckSelected" runat="server" Checked='<%#chkLevel(HDNSelUserFRLvl.value.tostring, Container.DataItem("LevelNo"))%>' Text='<%#Container.DataItem("LevelName")%>'  />                
