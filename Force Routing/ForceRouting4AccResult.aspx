<%@ Page Language="VB" AutoEventWireup="false" CodeFile="ForceRouting4AccResult.aspx.vb" Inherits="FRAResult" %>
...
<table border="1">
            ...
            <TH><div class="SMSelected">Account Number</div></TH>                        
            </TR>
</HeaderTemplate>
...
<tr>
            <td style="font-size: 8pt; font-family: Verdana;">
            <asp:CheckBox ID="ckSelected" runat="server" Checked='<%#chkLevel(HDNSelAccLvl.value.tostring, Container.DataItem("LevelNo"))%>' Text='<%#Container.DataItem("LevelName")%>'  />                
