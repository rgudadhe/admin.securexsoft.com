<%@ Page Language="VB" AutoEventWireup="false" CodeFile="ForceRouting4PhyResultNew.aspx.vb" Inherits="FRPResult" %>
...
<tr>
            <td style="font-size: 8pt; font-family: Trebuchet MS;">
            <asp:CheckBox ID="ckSelected" runat="server" Checked='<%#chkLevel(HDNSelPhyLvl.value.tostring, Container.DataItem("LevelNo"))%>' Text='<%#Container.DataItem("LevelNameNew")%>'  />                
