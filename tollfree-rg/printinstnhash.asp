...
<form action="" method="">
	...
	<h3 class="desc"align="center"><U><%=request.form("d2")%></U></h3>
	</div>
	
	<ul>
	
	<li>
		<label class="desc">Step 1		Dial Toll Free Number (800)-801-9270 or (866)-890-5003.</label>
		<label class="desc">Step 2		Enter 4-digit Physician ID</label>
		<label class="desc">Step 3		Enter Password </label>
		<label class="desc">Step 4		Start dictating after you hear the beep</label>
	</li>
