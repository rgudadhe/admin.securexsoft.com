<%@ Page Language="VB" AutoEventWireup="false" CodeFile="FormAddCust.aspx.vb" Inherits="FormAddCust"%>
            ...
            <tr>
               ...
               <td class="style3">
                    <asp:DropDownList ID="ddaccname" runat="server" AppendDataBoundItems="True" 
                        ...
                        <asp:ListItem Selected="True" Text="Select Account" Value="0"></asp:ListItem>
                    </asp:DropDownList>
                </td>
             </tr>
            <tr>
                <td class="style6" bgcolor="#99CCFF">
                    Customer ID</td>
                <td class="style3">
                    <asp:TextBox ID="txtCustid" runat="server" class="style7" width="200px" ReadOnly="True" ></asp:TextBox>
                </td>
            </tr>
            <tr>
                <td class="style6" bgcolor="#99CCFF">
                    Billing ID</td>
                <td class="style3">
                    <asp:TextBox ID="txtbillid" runat="server" ReadOnly="True" ></asp:TextBox>
                </td>
            </tr>
            <tr>
                <td class="style6" bgcolor="#99CCFF">
                    Account ID</td>
                <td class="style3">
                    <asp:TextBox ID="txtaccid" runat="server" ReadOnly="True" ></asp:TextBox>
                </td>
            </tr>
            <tr>
