<%@ Page Language="VB" AutoEventWireup="false" CodeFile="AddTipOfTheWeek.aspx.vb" Inherits="TipOfTheWeek" %>
...
<body>
    ...
    <div>
     <table width="80%">
        ...
        <a href="ViewTipOfTheWeek.aspx" target="_self" ><strong><span class="common">View Tip Of The Week</span></strong></a>
        </div> 
        </div>
        </asp:Panel>
    </form>
