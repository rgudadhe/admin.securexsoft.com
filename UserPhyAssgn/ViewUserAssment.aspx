<%@ Page Language="VB" AutoEventWireup="false" CodeFile="ViewUserAssment.aspx.vb" Inherits="UserPhyAssgn_Default" EnableViewState="True" %>
    ...
    <div>
        ...
        <tr>
            <td class="HeaderDiv" colspan="3" style="height: 15px; text-align: center" valign="top">
                    <span style="font-family: Trebuchet MS; color: white;"><strong>View User Assignment</strong></span></td>
               </tr>
                        ...
                        <tr style="font-style: italic">
                            ...
                            <td style="width: 293px" >
                                <asp:DropDownList ID="DLUser" runat="server" Font-Names="Trebuchet MS" Font-Size="10pt">
                                </asp:DropDownList></td>
                            <td style="width: 293px">
                                ...
                                <asp:ListItem Text="Show All Records" Selected="True"   Value="A"></asp:ListItem> 
                                 <asp:ListItem Text="Group By Account"   Value="G"></asp:ListItem> 
                                </asp:DropDownList></td>
                        </tr>
                        <tr  class="tblbg2">
