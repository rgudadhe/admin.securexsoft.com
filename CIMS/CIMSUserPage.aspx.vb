...
Partial Class CIMSUserPage
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        If Request.QueryString("TID") <> "" Then
            ...
            Try
                Dim objCmdGetAccess As New Data.SqlClient.SqlCommand("SELECT Access FROM dbo.tblCIMSTicketsAccess WHERE UserID='" & Session("UserID") & "'", objConn)
    ...
    Protected Sub GetTicketHistory(ByVal TicketID As String)
        ...
        Try
            ...
            Dim objCmdRes As New Data.SqlClient.SqlCommand("SELECT * FROM dbo.tblCustomerTicketAction WHERE TicketID='" & TicketID & "' ORDER BY ActionDate DESC ", objConn)
    ...
    Protected Sub BindData(ByVal StrStatus As String, ByVal CallFrom As String)
        ...
        Try
            Dim objGetDept As New Data.SqlClient.SqlCommand("SELECT DepartmentID FROM dbo.tblUsers WHERE UserID='" & Session("UserID") & "'", objConn)
            ...
            objGetDept = Nothing
            If String.IsNullOrEmpty(varStrDeptID) Then
                CIMSUserTabContainer.Visible = False
                lblMessage.Visible = True
                lblMessage.Text = "You have no Department assigned!"
                Exit Sub
            End If
            ...
            Dim objCmdRecCountOpen As New Data.SqlClient.SqlCommand("SELECT Count(*) AS RecordCount FROM dbo.tblCustomerTickets T LEFT JOIN dbo.tblCustomerTicketAction TA ON T.TicketID = TA.TicketID WHERE Status='Open' AND TA.ForwardDepartmentID='" & varStrDeptID & "'", objConn)
            ...
            Dim objCmdRecCountClose As New Data.SqlClient.SqlCommand("SELECT Count(*) AS RecordCount FROM dbo.tblCustomerTickets T LEFT JOIN dbo.tblCustomerTicketAction TA ON T.TicketID = TA.TicketID WHERE Status='Close' AND TA.ForwardDepartmentID='" & varStrDeptID & "'", objConn)
