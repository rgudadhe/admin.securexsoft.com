...
Partial Class CSMainPage
    ...
    Protected Sub BindData(ByVal StrStatus As String, ByVal CallFrom As String)
        ...
        Try
            If Trim(UCase(varStrStatus)) <> Trim(UCase("Any")) Then
                varStrQueryString = "SELECT C.*,A.AccountName FROM DBO.tblCustomerTickets C INNER JOIN dbo.tblAccounts A ON C.AccID=A.AccountID WHERE Status='" & varStrStatus & "' ORDER BY DatePosted DESC "
                varStrQueryCount = "SELECT Count(*) AS RecordCount FROM dbo.tblCustomerTickets WHERE Status='" & varStrStatus & "'"
            Else
                varStrQueryString = "SELECT C.*,A.AccountName FROM dbo.tblCustomerTickets C INNER JOIN dbo.tblAccounts A ON C.AccID=A.AccountID ORDER BY DatePosted DESC "
            ...
            Dim objCmdRecCountOpen As New Data.SqlClient.SqlCommand("SELECT Count(*) AS RecordCount FROM dbo.tblCustomerTickets WHERE Status='Open' ", objConn)
            ...
            Dim objCmdRecCountClose As New Data.SqlClient.SqlCommand("SELECT Count(*) AS RecordCount FROM dbo.tblCustomerTickets WHERE Status='Closed'", objConn)
            ...
            lblLinkBtnCloseTickets.Text = varIntCloseTickets & " Closed Tickets "
    ...
    Protected Sub BtnAddIssueType_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles BtnAddIssueType.Click
        ...
        varStrIssueType = Replace(txtIssueName.Text.ToString, "'", "''")
        varStrIssueDesc = Replace(txtDesc.InnerText.ToString, "'", "''")
    ...
    Protected Sub GridViewIssueTypes_RowUpdating(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewUpdateEventArgs) Handles GridViewIssueTypes.RowUpdating
        ...
        varStrIssueID = DirectCast(GridViewIssueTypes.Rows(e.RowIndex).FindControl("txtIssueID"), HiddenField).Value.ToString
        varStrIssueName = Replace(DirectCast(GridViewIssueTypes.Rows(e.RowIndex).FindControl("txtIssueName"), TextBox).Text, "'", "''")
        varStrDesc = Replace(DirectCast(GridViewIssueTypes.Rows(e.RowIndex).FindControl("txtIssueDesc"), TextBox).Text, "'", "''")
    ...
    Public Function CheckIssueName(ByVal StrIssueName As String, ByVal IssueID As String) As Boolean
        ...
        Try
            Dim oCommandIssueNameCheck As New Data.SqlClient.SqlCommand(varStrQuery, objConn)
    ...
    Protected Sub LinkBtnCloseTickets_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles LinkBtnCloseTickets.Click
        ...
        varStrTStatus = "Closed"
        lblView.Text = varStrTStatus
        BindData(varStrTStatus, "Closed")
    End Sub
        ...
        Try
            ...
            For varIntI = 0 To varArrUserName.Count - 1
                ...
                ElseIf Trim(UCase(varArrActionType(varIntI))) = Trim(UCase("Added Comments")) Then
                    ...
                    'objConn.ConnectionString = ConStringClient
    ...
    Protected Sub AddControls(ByVal varStrTID As String, ByVal Flag As Boolean)
        ...
        Try
            ...
            varLstItemClose.Text = "Closed"
            varLstItemClose.Value = "Closed"
            ...
            If Flag = True Or Session("Forward") Then
                ...
                Dim objCmdDept As New Data.SqlClient.SqlCommand("SELECT DepartmentID,Name FROM dbo.tblDepartments WHERE Deleted<>'TRUE'", objConn)
    ...
    Protected Sub BtnSubmit_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles BtnSubmit.Click
        ...
        varStrSubject = Replace(varCtrlTextBoxSubject.Text.ToString, "'", "''")

        varCtrlTextAreaMessage = DirectCast(PlaceHolerID.FindControl("txtAreaMessageInDetails"), HtmlTextArea)
        varStrMessage = Replace(varCtrlTextAreaMessage.InnerText.ToString, "'", "''")
        ...
        Try
            ...
            Dim varStrUserName As String
            Dim objCmd As New Data.SqlClient.SqlCommand("SELECT D.Name FROM dbo.tblDepartments D INNER JOIN dbo.tblUsers U ON U.DepartmentID=D.DepartmentID WHERE UserID='" & Session("UserID") & "'", objConn)
            Dim objRec As Data.SqlClient.SqlDataReader = objCmd.ExecuteReader
            If objRec.HasRows Then
                While objRec.Read
    ...
    Protected Sub BtnSearch_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles BtnSearch.Click
        ...
        varTDate = DateAdd(DateInterval.Day, 1, CDate(varDtEndDate))
        ...
        If varDtStartDate.ToString <> "" And varDtEndDate.ToString <> "" Then
            ...
            varStrDatePostedQuery = " DatePosted >= '" & varDtStartDate & "' AND DatePosted <= '" & varTDate.ToString & "'"
        Else
            ...
            For varIntI = 2 To tblSearchResultInTicketManagement.Rows.Count - 1
                ...
                For Each varCtrl In varTblCell.Controls
                    ...
                    If varBolChk Then
                        ...
                        Dim objGetAccess As New Data.SqlClient.SqlCommand("SELECT Access FROM dbo.tblCIMSTicketsAccess WHERE UserID='" & varStrUserID.ToString & "'", objConn)
