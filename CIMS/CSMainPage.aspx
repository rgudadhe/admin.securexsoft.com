                                            ...
                                            <div id="TblCellDiv"  runat=server>
                                                <asp:GridView ID="GridViewCustTickets" Width="100%" Height=280 Font-Names="Trebuchet MS" AllowPaging=true AllowSorting=true runat="server"
                                                 ...
                                                 <Columns>
                                                    ...
                                                    <asp:TemplateField HeaderText="Account Name" HeaderStyle-HorizontalAlign=Center SortExpression="AccountName">
                                                        <ItemTemplate>
                                ...
                                <asp:UpdatePanel ID="UpdatePanel2" runat="server">
                                    <ContentTemplate>
                                        <asp:Table ID="tblViewTicket" runat="server" Visible=false HorizontalAlign=Center BorderColor=LightBlue BorderWidth=1 Font-Names="Trebuchet MS" Width=95%>
                                            <asp:TableRow>
                                                <asp:TableCell>
                                                    <asp:Label ID="Label3" runat="server" Font-Names="Trebuchet MS" Font-Size=Large ForeColor=Crimson Text="View Ticket"></asp:Label>
                                                </asp:TableCell>
                                            </asp:TableRow>
                                            <asp:TableRow>
                                            ...
                                            <asp:TableRow>
                                                <asp:TableCell VerticalAlign=Bottom>
                                                    <asp:Button ID="BtnReply" runat="server" CssClass="Buttons" Font-Names="Trebuchet MS" CommandArgument="Reply" Text="Reply to Customer"  CausesValidation=false /> &nbsp
                                                    <asp:Button ID="BtnForward" runat="server" CssClass="Buttons" Text="Forward Ticket" Font-Names="Trebuchet MS" CommandArgument="Forward" CausesValidation=false /> &nbsp
                                                    <asp:Button ID="BtnPrint"  runat="server" CssClass="Buttons" Font-Names="Trebuchet MS" Text="Print" UseSubmitBehavior=false CausesValidation=false /> &nbsp
                                                    <asp:Button ID="BtnLog" runat="server" CssClass="Buttons" Font-Names="Trebuchet MS" Text="Log" CausesValidation=false /> &nbsp
                                                    <asp:Button ID="BtnReloadTicketList" CssClass="Buttons" runat="server" Font-Names="Trebuchet MS" Text="Reload Ticket List" CausesValidation=false /> &nbsp<hr style="color:LightBlue;">
                                                </asp:TableCell>
                                            </asp:TableRow>
                                            <asp:TableRow>
                                                <asp:TableCell>
                ...
                <ContentTemplate>
                    <asp:UpdatePanel ID="UpdatePanelIssueManagement" runat="server">
                        <ContentTemplate>
                            ...
                            <asp:SqlDataSource ID="sqlDataSource1" runat=server ConnectionString="<%$ ConnectionStrings:ETSConnectionString %>" SelectCommand="SELECT * FROM Ets.dbo.tblCustomerIssueType where IsDeleted IS NULL" >
                            </asp:SqlDataSource>
                        </ContentTemplate>
                    </asp:UpdatePanel>
                </ContentTemplate>
                            ...
                            <asp:Table ID="Table1" BackColor="GhostWhite" runat=server BorderColor=Lightblue BorderWidth=1 Font-Names="Trebuchet MS" Width=95% HorizontalAlign=Center>
                                <asp:TableRow>
                                    <asp:TableCell>
                                        ...
                                        Forwarded Ticket To : 
                                        <asp:DropDownList ID="DropDownDeptIDInSearch" Font-Names="Trebuchet MS" Width=150 runat="server">
                                        </asp:DropDownList>
                                        <hr style="color:White" />
                                        Status : 
                                        ...
                                        Order By :
                                        <asp:DropDownList ID="DropDownOrderByInSearch" Font-Names="Trebuchet MS" Width=120 runat="server">
                                            <asp:ListItem Text="TicketNo" Value="TicketNo"></asp:ListItem>
                                            <asp:ListItem Text="Priority" Value="Priority"></asp:ListItem>
                                            <asp:ListItem Text="Date Posted" Value="DatePosted"></asp:ListItem>
                                            <asp:ListItem Text="Account Name" Value="A.AccountName"></asp:ListItem>
                                        </asp:DropDownList> &nbsp 
                                        ...
                                        <asp:Button ID="BtnSearch" runat="server" CssClass="Buttons" Text="Search" Font-Names="Trebuchet MS" CausesValidation=false /> &nbsp &nbsp
                                        <asp:Button ID="BtnDefault" runat="server" CssClass="Buttons" Text="Default" Font-Names="Trebuchet MS" CausesValidation=false />
                                    </asp:TableCell>
                                </asp:TableRow>
                            </asp:Table>
                            <BR><BR><BR>
                                        ...
                                        <asp:Table ID="tblSearchTicketNo" runat="server" BorderColor=LightBlue BorderWidth=1>
                                            <asp:TableRow>  
                                                ...
                                                <asp:TableCell BackColor="GhostWhite">
                                                    <asp:TextBox ID="txtSearchTicketNo" Font-Names="Trebuchet MS" Width=100 Height=18 BorderColor=LightBlue BorderStyle=Solid BorderWidth=1 runat="server"></asp:TextBox> &nbsp
                                                    <asp:Button ID="BtnSearchTicketNo" runat="server" CssClass="Buttons" Font-Names="Trebuchet Ms" Text="Search" CausesValidation=false />
                                                </asp:TableCell>
                                            </asp:TableRow>
                                        </asp:Table>
                                    </asp:TableCell>
            ...
            <ajaxToolkit:TabPanel ID="TabTicketManagement" BorderColor=LightBlue BorderWidth=1 runat=server>
                ...
                <ContentTemplate>
                    <asp:UpdatePanel ID="UpdatePanelInTicketManagement" runat="server">
                        <ContentTemplate>
                            <asp:Table ID="tblSearchInTicketManagement" runat="server" BackColor="GhostWhite" BorderColor=Lightblue BorderWidth=1 Font-Names="Trebuchet MS" Width=95% HorizontalAlign=Center>
                                <asp:TableRow>
                                    <asp:TableCell>
                                        Look for :
                                        <asp:TextBox ID="txtLookforInTicketManagement" runat="server" Font-Names="Trebuchet MS" Width=200 Height=18 BorderColor=LightBlue BorderStyle=Solid BorderWidth=1></asp:TextBox> &nbsp &nbsp    
                                        In : 
                                        <asp:DropDownList ID="DropDownLookINTicketManagement" runat="server" Font-Names="Trebuchet MS" Width=100>
                                            <asp:ListItem Value="Any" Text="Any"></asp:ListItem>
                                        ...
                                        Department : 
                                        <asp:DropDownList ID="DropDownListDeptIDINTicketManagement" runat="server" Font-Names="Trebuchet MS" Width=150 BorderColor=LightBlue BorderStyle=Solid BorderWidth=1 EnableViewState=true>
                                        </asp:DropDownList> &nbsp &nbsp
                                        <asp:Button ID="BtnSearchInTicketManagement" CssClass="Buttons" CausesValidation=false runat="server" Font-Names="Trebuchet MS" Text="Search" />
                                    </asp:TableCell>
                                </asp:TableRow>
                            </asp:Table>
                            <BR><BR><BR>
                            <asp:Table ID="tblSearchResultInTicketManagement" runat="server" Width="95%" BorderColor=Lightblue BorderWidth=1 GridLines=Vertical Font-Names="Trebuchet MS" HorizontalAlign=Center>
                                <asp:TableRow>
                                    <asp:TableCell ColumnSpan=5>
                                        <asp:RadioButtonList ID="RadioButtonAccess" AutoPostBack=true OnSelectedIndexChanged="RadioButtonAccess_SelectedIndexChanged" Font-Names="Trebuchet MS" runat="server">
                            ...
                            <asp:Table ID="tblSearchTableInTicketManagement" runat="server" Width=95% HorizontalAlign=Center>
                                <asp:TableRow>
                                    <asp:TableCell HorizontalAlign=Center>
                                        <asp:Button ID="BtnSubmitInTicketManagement" CssClass="Buttons" runat="server" CausesValidation=false Font-Names="Trebuchet MS" Text="Update Access" /> &nbsp
