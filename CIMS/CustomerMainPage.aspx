                    ...
                    <asp:Table ID="Table1" runat="server" Width="85%" GridLines=Both>
                        ...
                        <asp:TableRow runat=server>
                            <asp:TableCell runat=server HorizontalAlign=Right VerticalAlign=Top Width=20%>
                                <asp:Label ID="lblSubject" Font-Names="Trebuchet MS" Font-Size=Small Font-Italic=True ForeColor=Gray  runat="server" Text="Subject :"></asp:Label>
                            </asp:TableCell>
                            <asp:TableCell HorizontalAlign=Left>
                                <asp:TextBox ID="txtSubject" runat="server" Font-Names="Trebuchet MS" Width=60%></asp:TextBox>&nbsp &nbsp
                                <asp:RequiredFieldValidator ID="RequiredFieldSubject" runat="server" ErrorMessage="Please enter subject" Font-Size=small Font-Names="Trebuchet MS" Font-Bold=true Font-Italic=true SetFocusOnError=true ControlToValidate="txtSubject"></asp:RequiredFieldValidator>
                            </asp:TableCell>
                        </asp:TableRow>
            ...
            <Ajax:TabPanel ID="TestTab3" BorderColor=LightBlue BorderWidth=1 runat=server >
                ...
                <ContentTemplate>
                    <asp:UpdatePanel ID="UpdatePanelSearch" runat="server">
                        <ContentTemplate>
                            <asp:Table BackColor="GhostWhite" runat=server BorderColor=Lightblue BorderWidth=1 Font-Names="Trebuchet MS" Width=95% HorizontalAlign=Center>
                                <asp:TableRow>
                                    <asp:TableCell>
                                        Look for : 
                                        ...
                                        <asp:Table ID="tblSearchTicketNo" runat="server" BorderColor=LightBlue BorderWidth=1>
                                            <asp:TableRow>  
                                                ...
                                                <asp:TableCell BackColor="GhostWhite">
                                                    ...
                                                    <asp:Button ID="BtnSearchTicketNo" runat="server" Font-Names="Trebuchet Ms" CssClass="Buttons" Text="Search" CausesValidation=false />
                                                </asp:TableCell>
                                            </asp:TableRow>
                                        </asp:Table>
                                    </asp:TableCell>
