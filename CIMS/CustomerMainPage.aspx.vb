...
Partial Class CustomerMainPage
    ...
    Protected Sub BtnAddNew_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles BtnAddNew.Click
        ...
        If FileUploadAttachment.FileName.ToString <> "" Then
            ...
            varStrInsert = "INSERT INTO tblCustomerTickets(Subject,AccID,UserID,IssueID,TicketDetails,AttachFile,Priority,Status,DatePosted)VALUES('" & varStrSubject & "','" & Session("AccID") & "','" & Session("UserID") & "','" & varStrIssueID & "','" & varStrTicketDetails & "','" & varStrFileAttach & "','" & varStrPriority & "','Open','" & Now() & "')"
        Else
            varStrInsert = "INSERT INTO tblCustomerTickets(Subject,AccID,UserID,IssueID,TicketDetails,Priority,Status,DatePosted)VALUES('" & varStrSubject & "','" & Session("AccID") & "','" & Session("UserID") & "','" & varStrIssueID & "','" & varStrTicketDetails & "','" & varStrPriority & "','Open','" & Now() & "')"
        End If
    ...
    Protected Sub BindData(ByVal StrStatus As String, ByVal CallFrom As String)
        ...
        If Trim(UCase(varStrStatus)) <> Trim(UCase("Any")) Then
            varStrQueryString = "SELECT * FROM dbo.tblCustomerTickets WHERE Status='" & varStrStatus & "' AND AccID='" & Session("AccID") & "'"
            varStrQueryCount = "SELECT Count(*) AS RecordCount FROM dbo.tblCustomerTickets WHERE Status='" & varStrStatus & "' AND AccID='" & Session("AccID") & "'"
        Else
            varStrQueryString = "SELECT * FROM dbo.tblCustomerTickets WHERE AccID='" & Session("AccID") & "'"
            varStrQueryCount = "SELECT Count(*) AS RecordCount FROM dbo.tblCustomerTickets WHERE AccID='" & Session("AccID") & "'"
        End If
        ...
        Try
            Dim objCmdRecCount As New Data.SqlClient.SqlCommand(varStrQueryCount, objConn)
            ...
            'Response.Write(varStrQueryCount)
            ...
            Dim objCmdRecCountOpen As New Data.SqlClient.SqlCommand("SELECT Count(*) AS RecordCount FROM dbo.tblCustomerTickets WHERE Status='Open' AND AccID='" & Session("AccID") & "' ", objConn)
            ...
            Dim objCmdRecCountClose As New Data.SqlClient.SqlCommand("SELECT Count(*) AS RecordCount FROM dbo.tblCustomerTickets WHERE Status='Close' AND AccID='" & Session("AccID") & "' ", objConn)
    ...
    Protected Sub BtnSubmit_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles BtnSubmit.Click
        ...
        Try
            varStrInsert = "INSERT INTO dbo.tblCustomerTicketAction (TicketID,Subject,ActionType,ActionBy,ActionDetails,ActionDate) VALUES('" & Session("TID") & "','" & varStrSubject & "','Added Comments','" & Session("AccID") & "','" & varStrMessage & "','" & Now() & "')"
            ...
            Dim varStrUserName As String
            Dim objCmd As New Data.SqlClient.SqlCommand("SELECT AccountName FROM dbo.tblAccounts WHERE AccountID='" & Session("AccID") & "'", objConn)
            Dim objRec As Data.SqlClient.SqlDataReader = objCmd.ExecuteReader
            If objRec.HasRows Then
                While objRec.Read
                    If Not objRec.IsDBNull(objRec.GetOrdinal("AccountName")) Then
                        varStrUserName = objRec.GetString(objRec.GetOrdinal("AccontName"))
                    End If
                End While
            End If
            objRec.Close()
    ...
    Protected Sub AddControls(ByVal varStrTID As String)
        ...
        Try
            Dim objTicketInfo As New Data.SqlClient.SqlCommand("SELECT Subject,Status,Priority FROM dbo.tblCustomerTickets WHERE TicketID='" & varStrTID & "'", objConn)
    ...
    Protected Sub BtnDefault_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles BtnDefault.Click
        ...
        Try
            varStrQuery = "SELECT TicketID,TicketNo,Subject,DatePosted,Priority,Status,DateSolved FROM dbo.tblCustomerTickets WHERE AccID='" & Session("AccID") & "' AND DatePosted BETWEEN '" & varStartDate & "' AND '" & varEndDate & "'"
            Dim objCmdSearch As New Data.SqlClient.SqlCommand(varStrQuery, objConn)
    ...
    Protected Sub BtnSearch_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles BtnSearch.Click
        ...
        varStrQuery = "SELECT TicketID,TicketNo,Subject,DatePosted,Priority,Status,DateSolved FROM dbo.tblCustomerTickets WHERE AccID='" & Session("AccID") & "'"
    ...
    Protected Sub BtnLog_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles BtnLog.Click
        ...
        Try
            ...
            Dim cmdLog As New Data.SqlClient.SqlCommand("SELECT ActionName,ActionDate FROM dbo.tblCustomerTicketsLog WHERE TicketID='" & Request.QueryString("TID") & "'", objConn)
    ...
    Protected Sub BtnSearchTicketNo_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles BtnSearchTicketNo.Click
        ...
        If varIntTicketNo <> "" Then
            ...
            objConn = objMainModule.OpenConnection(objConn)
            Try
                Dim objGetGUID As New Data.SqlClient.SqlCommand("SELECT TicketID FROM dbo.tblCustomerTickets WHERE TicketNo=" & varIntTicketNo & "", objConn)
