...
<table border="0" cellpadding="0" cellspacing="0" style="border-collapse: collapse; valign: top;" bordercolor="#111111" width="83%">
  <tr>
    <td width="100%">&nbsp;<table border="0" cellpadding="0" cellspacing="0" style="border-collapse: collapse" bordercolor="#111111" width="824">
      <tr>
        <td width="55%">
		...
		%>
		  <tr>
        <th colspan="3" dir="ltr"><font size="2" face="Arial">Prompt</font></th>
        </tr>
          <tr>
          <td bgcolor="#000080" dir="ltr" align="left" style="-webkit-print-color-adjust: exact;" width="77">
           <font color="#FFFFFF" size="2" face="Arial"><Strong>Prompt</strong></font></td>
            <td align="left" bgcolor="#000080" dir="ltr" style="-webkit-print-color-adjust: exact" width="77">
            <font color="#FFFFFF" size="2" face="Arial"><strong>Key In</strong></font></td>
            <td bgcolor="#000080" dir="ltr" align="left" style="-webkit-print-color-adjust: exact;" width="167"><font color="#FFFFFF" size="2" face="Arial" style="-webkit-print-color-adjust: exact;"><strong>Description</strong></font></td>
          </tr>	
	<%
		...
		%>
			...
			<tr>
					<td class="style1" dir="ltr"><a prompt="<%=pmpt%>"><%=pmpt%></a>&nbsp;</td>
					<td align="center" dir="ltr"><a keyin="<%=kn%>"><%=kn%></a>&nbsp;</td>
					<td class="style1" dir="ltr"><a description="<%=des%>"><%=des%></a>&nbsp;</td>
