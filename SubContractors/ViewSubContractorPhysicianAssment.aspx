<%@ Page Language="VB" AutoEventWireup="false" CodeFile="ViewSubContractorPhysicianAssment.aspx.vb" Inherits="UserPhyAssgn_Default" EnableViewState="True" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 1.0 Transitional/EN">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head runat="server">
    <title>View Physicians to Subcontractors</title>
...
<body>
    <form id="form1" runat="server">
        ...
        <div id="cap"></div>
        <div id="main">
        <h1>View SubContractor - Dictators Assignment</h1>
            <asp:Panel ID="Panel3" runat="server" HorizontalAlign="Left">
                <div>
        <table id="MainTable" width="80%">
        <tr>
                <td style="width: 768px; text-align: center;" valign="top" colspan ="1" class="HeaderDiv">
                    View SubContractor - Dictator Assignment
                </td>
               </tr>
                
            <tr>
                <td style="width: 768px; text-align: center;" valign="top">
                        ...
                        <table width="50%" >
                            ...
                            <tr>
                                ...
                                <td style="text-align: left" >
                                    <asp:TextBox ID="TxtUname" CssClass="common" runat="server"></asp:TextBox></td>
                            </tr>
                            <tr>
                                <td style="text-align: center; height: 30px;" colspan="2">
                                    <asp:Button ID="BtnSubmit1" CssClass="button" runat="server" Text="Submit" UseSubmitBehavior="False" />
                                </td>
                            </tr>
                        </table>
                        </asp:Panel>
            ...
            <tr>
                <td colspan="1" style="text-align: center; width: 768px;">
                    <asp:Table  ID="Table4" runat="server" Width="100%">
                        <asp:TableRow ID="TableRow2" runat="server" style="text-align: center">
                            <asp:TableCell ID="TableCell4" runat="server" cssclass="alt1">SubContractor Name</asp:TableCell>
                            <asp:TableCell ID="TableCell5" runat="server" cssclass="alt1">Description</asp:TableCell>
                            <asp:TableCell ID="TableCell6" runat="server" cssclass="alt1">Account Name</asp:TableCell>
                            <asp:TableCell ID="TableCell7" runat="server" cssclass="alt1">Dictator Name</asp:TableCell>
