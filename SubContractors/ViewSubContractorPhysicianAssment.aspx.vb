...
Partial Class UserPhyAssgn_Default
    ...
    Protected Sub ActUserAssign()
        ...
        If HContrID.Value <> "" Then
            sQuery3 = "Select CP.TrackID, C.ContractorName, C.Description , A.AccountName, P.firstname + ' ' + P.lastname as uname from tblcontractor C, tblSubCont2Physicians CP, tblAccounts A, tblphysicians P where P.AccountID = A.AccountID and P.physicianID = CP.PhysicianID and CP.ContractorID = C.ContractorID and C.ContractorID ='" & HcontrID.Value & "' order by C.ContractorName"
