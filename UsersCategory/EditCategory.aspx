<%@ Page EnableEventValidation="False" Language="VB" AutoEventWireup="false" CodeFile="EditCategory.aspx.vb" Inherits="Department_Default" %>
...
{
    url="CategoryDet.aspx?CatID="+ inpt;
    //alert(inpt);
...
<tr align="center">
<td  colspan="3" class="HeaderDiv" style=" text-align:center; " >Users Category Details</td>
</tr>
...
<td  align="center">
    <asp:Button ID="Button1" runat="server" Text="Edit" CssClass="button" CommandName="OpenWin" CommandArgument='<%#DataBinder.Eval(Container.DataItem, "CategoryID")%> ' OnClientClick='<%# String.Concat("poptastic(""", Eval("CategoryID"), """);") %>'  />
 </td>
