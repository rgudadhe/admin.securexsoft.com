...
Partial Class AthenaHealthAPIBrowser
    ...
    Private Function Connect() As Data.SqlClient.SqlConnection
        ...
        End Try
    End Function
    Private Function GetPhysicians(practiceid As Integer, AccountNo As Integer)
        ...
        End Try
    End Function
    Private Function GetChangedAppointmentsMultiDepartment(_ProviderIDs As String, practiceid As String) As Boolean
        Try
