<%@ Page Language="VB" AutoEventWireup="false" CodeFile="ViewNewsArt.aspx.vb" Inherits="ViewNewsArt" %>
...
<body>
    <form id="form1" runat="server">
     ...
     <ajaxToolkit:CollapsiblePanelExtender ID="cpeDemo" runat="Server"
        ...
        /> 
       <br />
            <asp:GridView ID="MyDataGrid" runat="server" CssClass="tablesorter" AutoGenerateColumns="False" Width="100%">
                <Columns>
                    <asp:TemplateField HeaderText="Date Posted" ItemStyle-Width="100">
                        <ItemTemplate>
