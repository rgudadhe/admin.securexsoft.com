...
'<tr name="title" id="title" style="background-image:url(../../styles/pro_7/background_parentselected.gif);font-family:Tahoma; font-size:8pt;font-weight:bold;color:white" ><td width="100%" style="padding-left:3px;" align="center">'+ TTitle + '</td></tr>'+
'</table>'+
'</td></tr>'+
'<tr><td width="100%" bgcolor='+subColor+'>'+
'<table border="0" width="99%" cellpadding="0" cellspacing="1" align="center">'+
'<tr><td width="100%" bgcolor="whitesmoke" style="padding-left:3px;font-family:Trebuchet MS; font-size:8pt">' + TContent + '</td></tr>'+
'</table>'+
'</td></tr>'+
'</table>'+
'</td></tr>'+
