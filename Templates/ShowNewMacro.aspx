<%@ Page Language="VB" AutoEventWireup="false" CodeFile="ShowNewMacro.aspx.vb" Inherits="Dictation_Search_ShowPDF" %>
            ...
            <tr>
                                                        ...
                                                        <ItemTemplate>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td style="text-align: left !important;width: 20px !important;">
                                                                      ...
                                                                      <input type="checkbox"  id="checkbox1" readonly checked="checked" value='<%# Eval("PhysicianID")%>' runat="server" />
                ...
                <td style=" vertical-align: top; " >
                  ...
                  <a href="<% =MediaURL%>" target="_blank">
                      <asp:Label ID="lblFileName" Font-Bold="true" Font-Size ="Medium"   runat="server" ></asp:Label></a>  
