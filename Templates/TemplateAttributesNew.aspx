<%@ Page Language="VB" AutoEventWireup="false" CodeFile="TemplateAttributesNew.aspx.vb" Inherits="Templates_TemplateAttributesNew" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <div id="cap"></div>
        <div id="main">
        <h1>Attribute assignments for Template</h1>
       ...
       <tr>
          ...
          <td rowspan="2" style="background-color: #ffffff">	
                <asp:ImageButton ID="btnAddDefault" runat="server" ImageUrl="~/App_Themes/Images/RightDefault1.jpg" ToolTip="Add Default Attribute Set" Visible="false" />
          		<b></b>
