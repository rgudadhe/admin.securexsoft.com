<%@ Page Language="VB" AutoEventWireup="false" CodeFile="DMTemplateAssignments.aspx.vb" Inherits="DMTemplateAssignments" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <div id="cap"></div>
        <div id="main">
        <h1>Document Model Assignments </h1>
                        ...
                        <ContentTemplate>--%>
                            <table class="common" border="0">
                                <tr>
                                    ...
                                    <td colspan="1" style="border:0">
                                        <asp:DropDownList ID="DDLPhysicians"  runat="server" CssClass="common" AutoPostBack="true">
                                        </asp:DropDownList>
                                    </td>
                                     <td colspan="1" style="border:0">
                                        <asp:DropDownList ID="DDLDM"  runat="server" CssClass="common" AutoPostBack="true">
                                        </asp:DropDownList>
                                    </td>
                                </tr>
                                </table>
                                ...
                                <tr>
                                    <td class="alt1">
                                        <div style="text-align:center">Assigned Templates</div>
                                    </td>
                                    <td class="alt1" align="center" style="width:30px;">
                                        &nbsp;
                                    </td>
                                    <td class="alt1" align="center">
                                        <div style="text-align:center">Available Templates</div>
                                    </td>
                                </tr>
                                <tr>
                                    <td >
