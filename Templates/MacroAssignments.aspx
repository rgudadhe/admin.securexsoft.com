<%@ Page Language="VB" AutoEventWireup="false" CodeFile="MacroAssignments.aspx.vb" Inherits="MacroAssignments" %>
                    ...
                    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                        <ContentTemplate>
                            <table class="common" border="0">
                                ...
                                <tr>
                                    <td class="alt1">
                                        <div style="text-align:center">Assigned Physicians</div>
                                    </td>
                                    <td class="alt1" align="center" style="width:30px;">
                                        &nbsp;
                                    </td>
                                    <td class="alt1" align="center">
                                        <div style="text-align:center">Available Physicians</div>
                                    </td>
                                </tr>
                                <tr>
                                    <td >
