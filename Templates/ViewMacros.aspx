<%@ Page EnableEventValidation="False" Language="VB" AutoEventWireup="false" CodeFile="ViewMacros.aspx.vb" Inherits="ViewMacro" %>
...
function poptastic1(inpt) {
    url = "ShowComparePDF.aspx?McID=" + inpt;
...
<td align="center"><%#DataBinder.Eval(Container.DataItem, "McName")%> </span></td>
...
<td  align="center">
    <asp:Button ID="Button1" runat="server" Text="Edited" CssClass="button" CommandName="OpenWin" CommandArgument='<%#DataBinder.Eval(Container.DataItem, "McID")%> ' OnClientClick='<%# String.Concat("poptastic(""", Eval("McDet"), """);") %>'  />
 </td>
 <td  align="center">
    <asp:Button ID="Button2" runat="server" Text="Compare" CssClass="button" CommandName="OpenWin" CommandArgument='<%#DataBinder.Eval(Container.DataItem, "McID")%> ' OnClientClick='<%# String.Concat("poptastic1(""", Eval("McDet"), """);") %>'  />
 </td>
</tr>
</ItemTemplate>
