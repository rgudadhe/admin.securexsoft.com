<%@ Page Language="VB" AutoEventWireup="false" CodeFile="MacroPhySearch.aspx.vb" Inherits="ets.Templates_TA_PhySearch" %>
...
<ItemTemplate>
<tr>        
            <td><asp:CheckBox ID="chkID" runat="server"  /></td>    
...
<FooterTemplate>
        ...
        <asp:Button ID="btnAssignPhy" CssClass="button" runat="server" Text="Assign Physician" />
        <asp:HiddenField ID="hdnPhysicianID" runat="server" />
        <asp:HiddenField ID="hdnPhysicianName" runat="server" />
    </div>
    </div> 
    </div> 
    </form>
