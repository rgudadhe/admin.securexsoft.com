...
<center>
    ...
    <table style="font-family: Arial; border-color:Navy" border="1">
        ...
        <tr>
            <td colspan="2" style="font-size:smaller; font-weight:bold" align="right">Account Name</td>
        ...
        <tr>
            <td colspan="4" style="background-color:Blue"><strong><span style="color: #ffffcc">
                Search ID</span></strong></td>
             
        </tr>
       
        <tr>
            <td colspan="2" style="text-align: right;font-size:smaller" class="style3">
                Enter ID</td>
