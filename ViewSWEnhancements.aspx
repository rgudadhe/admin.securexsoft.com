<%@ Page Language="VB" AutoEventWireup="false" CodeFile="ViewSWEnhancements.aspx.vb" Inherits="ViewUpd" %>
               ...
               <asp:CompleteGridView ID="MyDataGrid" runat="server" AllowSorting="True" 
                ...
                <PagerSettings PreviousPageText="Previous" PageButtonCount="25" Mode="NumericFirstLast" LastPageText="Last Page" FirstPageText="First Page" NextPageText="Next Page"></PagerSettings>
                          ...
                          <Columns>
                              ...
                              <asp:BoundField ControlStyle-Width = "95%" DataField="ReleaseDate"   HeaderText="Release Date" SortExpression="ReleaseDate" HeaderStyle-CssClass="alt1" />
                              <asp:BoundField ControlStyle-Width = "95%" DataField="Enhancement"   HeaderText="Enhancement" SortExpression="Enhancement" HeaderStyle-CssClass="alt1" />
