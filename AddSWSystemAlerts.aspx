<%@ Page Language="VB" AutoEventWireup="false" CodeFile="AddSWSystemAlerts.aspx.vb" Inherits="SystemAlerts" %>
...
<body>
    <form id="form1" runat="server">
     <asp:ScriptManager ID="ScriptManager1" runat="server">
        ...
        <div id="cap"></div>
        <div id="main">
        <h1>Add SecureWeb System Alert</h1>
    <div>
     <table width="80%">
            ...
            <tr>
                <td style="text-align: right" valign="top"  >
                    Alert</td>
                <td style="text-align: left;">
                    <asp:TextBox ID="TxtAlert" runat="server" MaxLength="450"  CssClass="common" TextMode="MultiLine" Height="168px" Width="520px"></asp:TextBox></td>
            </tr>
            <tr>
        ...
        <br />
        <a href="ViewSWSystemAlerts.aspx" target="_self" ><strong><span class="common">View System Alerts</span></strong></a>
        </div> 
        </div>
        </asp:Panel>
    </form>
