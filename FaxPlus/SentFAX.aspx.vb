...
Partial Class FaxPlus_SentFAX
    ...
    Public Sub LoadData()
        ...
        Try
            ...
            DS = clsFAX.GetSentFAXRecords(varAccID.ToString, varsDate.ToString, vareDate.ToString)

            If DS.Tables.Count > 0 Then
                If DS.Tables(0).Rows.Count > 0 Then
                    GridViewMain.DataSource = DS.Tables(0)
                    GridViewMain.DataBind()
                    LnkExport.Visible = True
                Else
                    GridViewMain.DataSource = Nothing
                    GridViewMain.DataBind()
