<%@ Page Language="VB"  CodeFile="Login.aspx.vb" Inherits="Login" %>
<!DOCTYPE HTML>
...
<asp:Label ID="lblErrorMsg" runat="server" Visible="false" CssClass="lblErrorMsg" Text="This User Is Already LoggedIn"></asp:Label>
...
<div class="divider" style="text-align:center;">
  <asp:Button ID="btnSubmit" runat="server" Text=""  EnableViewState="False"  class="login-button" value="" style="border:0px; height:50px; background-color:transparent; box-shadow:none; width:60%;" OnClick="btnsubmit_Click" ></asp:Button>
       
      </div>

<div  class="divider-footer">
<div style="float:left;"><a href="javascript:var w=window.open('https://securexsoft.com/System-Requirements.html', '_blank', 'width=1024,height=750');" onclick="" style="font-family:Arial ; font-size:10pt;">System Requirements</a></div> 
<div style="float:right;"><a href="javascript:var w=window.open('https://www.medofficepro.com/support-policy.html', '_blank', 'width=1024,height=750');" style="margin-left:17px; font-family:Arial; font-size:10pt; right: auto;">Support Policy</a></div>
