...
Partial Class Transcend_Mapping
    ...
    Private Function DoSearch(ByVal UserName As String, ByVal AccName As String, ByVal Status As String, ByVal Sort As String, ByVal Dir As String) As Boolean
        ...
        Try
            ...
            Dim oCommand As New Data.SqlClient.SqlCommand("SELECT UserID,UserName FROM DBO.tblUsers where  (Isdeleted is NULL or Isdeleted = 'False') and UserID<>'11111111-1111-1111-1111-111111111111' AND FirstName+' '+LastName LIKE '" & UserName & "'", oConn)
