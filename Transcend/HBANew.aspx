<%@ Page Language="VB" AutoEventWireup="false" CodeFile="HBANew.aspx.vb" Inherits="Transcend_HBA" %>
...
<body>
    ...
    <div>
        ...
        <table width="100%">
            <tr>
                <td align="left">
                    <asp:Label ID="lblMsg" runat="server" Text="" ForeColor="Red" Font-Italic="true" Font-Bold="true"></asp:Label>
                </td>
            </tr>
        </table>
        <table width="100%" >
            ...
            <tr>
                <td align="left">
                    <asp:LinkButton ID="LnlExport" runat="server" CausesValidation="false" CssClass="common" >Export List</asp:LinkButton>                    
                </td>
            </tr>
            <tr>
                <td align="center">
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Lines" SortExpression="Lines" HeaderStyle-HorizontalAlign="Center" HeaderStyle-CssClass="alt1">
                            <ItemTemplate>
                                <asp:Label ID="lblLines" runat="server" Text='<%#Eval("PR_Lines").ToString%>'></asp:Label>
                            </ItemTemplate>
                        </asp:TemplateField>
        ...
        <asp:datagrid id="dgResultsData" 
				...
				<Columns>
				    ...
				    <asp:TemplateColumn HeaderText="Lines" >
				        <ItemTemplate>
                            <asp:Label ID="lblLines" runat="server" Text='<%# Container.DataItem("PR_Lines").ToString%>'></asp:Label>
                        </ItemTemplate>
				    </asp:TemplateColumn>
