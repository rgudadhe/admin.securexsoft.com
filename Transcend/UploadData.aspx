<%@ Page Language="VB" AutoEventWireup="false" CodeFile="UploadData.aspx.vb" Inherits="Transcend_MTVHSData1" %>
            ...
            <table style="text-align:center " width="80%" border="0" >
                <tr>
                    <td align="left" style="border:0">
                        Month <asp:DropDownList ID="DLMonth1" runat="server" CssClass="common">
                                    </asp:DropDownList>
                    </td>
                    <td align="right" style="border:0">
                       
                       Year  <asp:DropDownList ID="DLYear1" runat="server" CssClass="common">
