<%@ Page Language="VB" AutoEventWireup="false" CodeFile="ViewDirectstatus.aspx.vb" Inherits="UserPhyAssgn_Default" EnableViewState="True" %>
        ...
        <table id="MainTable" width="600" style="font-size: 10pt; font-family: 'Trebuchet MS'; font-style: italic;" border ="2" cellpadding ="2" cellspacing ="2" >
                        ...
                        <tr class="SMSelected">
                            <td colspan="6" style="text-align: center">
                                <b>MTDirect Summary Report</b></td>
                        </tr>
                        <tr class="SMSelected">
                            <td style="height: 20px;  text-align: center; ">
                                Name</td>
                            <td style=" height: 20px;text-align: center" colspan="2">
                                Start Modified Date</td>
                            <td style=" height: 20px;text-align: center; width: 172px;">
                                End Modified Date</td>
                        </tr>
                        <tr>
                            <td colspan="1" style="height: 30px; text-align: center; ">
                                <asp:DropDownList ID="UserList" runat="server" Font-Names="Trebuchet MS" Font-Size="Small">
                                </asp:DropDownList></td>
                            <td colspan="1" style="height: 30px; text-align: center">
                                  &nbsp;
