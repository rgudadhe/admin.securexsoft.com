<%@ Page Language="VB" AutoEventWireup="false" CodeFile="DailyMins.aspx.vb" Inherits="MIS_DailyMins" %>
                ...
                <table width="100%">
                    <tr>
                        <td colspan="3" class="HeaderDiv">
                            Daily Minutes Report - Submit Date
     ...
     <ajaxToolkit:CollapsiblePanelExtender ID="cpeDemo" runat="Server"
        ...
        <asp:Panel ID="Panel3" runat="server" HorizontalAlign="Left">
            <asp:Table ID="tblMins" runat="server" Width="100%"  CellSpacing="2" CellPadding="10"  GridLines="Both" >
                ...
                <asp:TableRow ID="TableRow3" runat="server" CssClass="alt1" >
                ...
                <asp:TableRow ID="TableRow4" runat="server"  CssClass="alt1">
...
runat="server" 
ErrorMessage="Submit Date - Please enter valid input.">
