<%@ Page Language="VB" AutoEventWireup="false" CodeFile="DailyTAT.aspx.vb" Inherits="MIS_DailyMins" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <div id="cap"></div>
        <div id="main">
        <h1>Daily TAT By Submit Date</h1>
        <asp:ScriptManager ID="ScriptManager1" runat="server">
           ...
           <table width="100%">
             <tr>
                <td class="HeaderDiv">
                    Daily TAT Report - Submit Date
                    <asp:ImageButton ID="ImageButton2" runat="server" ImageUrl="~/App_Themes/Images/expand_blue.jpg" AlternateText="(Show Details...)" />
                </td>
            </tr>
          </table> 
          </asp:Panel> 
          <asp:Panel ID="Panel1" runat="server" width="100%" HorizontalAlign="Left">
           ...
           <tr>
            <td style="text-align:center" class="alt1">
                <asp:TextBox ID="TXTSDate" Width="100" CssClass="common" runat="server"></asp:TextBox>
                ...
                <ajaxToolkit:CalendarExtender ID="CalendarExtender1" CssClass="cal_Theme1" runat="server" Format="MM/dd/yyyy" TargetControlID="TXTSDate" PopupButtonID="imgSDate" BehaviorID="CalendarExtender1" Enabled="True"></ajaxToolkit:CalendarExtender>
            </td>
            <td style="text-align:center" class="alt1">
        ...
        <asp:Panel ID="Panel3" runat="server" HorizontalAlign="Left">
            <asp:Table ID="tblMins" runat="server" Width="100%"  CellSpacing="2" CellPadding="10"  GridLines="Both" >
                ...
                <asp:TableRow ID="TableRow3" runat="server" HorizontalAlign="Center">
                    ...
                    <asp:TableCell runat="server" ID="R1Cell2" ColumnSpan="8" CssClass="alt1" >Number Of Jobs</asp:TableCell>
                    <asp:TableCell runat="server" ID="R1Cell3" ColumnSpan="5" CssClass="alt1">Total Mins</asp:TableCell>
                    <asp:TableCell runat="server" ID="TableCell1" ColumnSpan="5" CssClass="alt1">Jobs Related</asp:TableCell> 
                </asp:TableRow>
