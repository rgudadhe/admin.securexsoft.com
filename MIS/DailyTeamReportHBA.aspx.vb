...
Partial Class MIS_DailyMins
    ...
    Protected Sub ShowActDetails()
        ...
        strQuery = strQuery & " WHERE T.STATUS = '1073741824' and TS.TRANSCRIPTIONID = T.TRANSCRIPTIONID AND TS.USERLEVEL = '1' AND  TS.STATUS IN ('2') "
        ...
        strQuery = strQuery & " LEFT JOIN (SELECT TS.USERID, SUM(TS.LINECOUNT) AS TSLINES FROM TBLTRANSCRIPTIONSTATUS TS, TBLTRANSCRIPTIONMAIN T"
        strQuery = strQuery & " WHERE T.STATUS = '1073741824' and TS.TRANSCRIPTIONID = T.TRANSCRIPTIONID AND TS.USERLEVEL = '1' AND  TS.STATUS NOT IN ('2', '8') "
        ...
        strQuery = strQuery & " LEFT JOIN (SELECT TS.USERID, SUM(TS.LINECOUNT) AS TSLINES FROM TBLTRANSCRIPTIONSTATUS TS, TBLTRANSCRIPTIONMAIN T"
        strQuery = strQuery & " WHERE T.STATUS = '1073741824' and TS.TRANSCRIPTIONID = T.TRANSCRIPTIONID AND TS.USERLEVEL = '2'  AND  TS.STATUS NOT IN ('8') "
        ...
        strQuery = strQuery & " LEFT JOIN (SELECT TS.USERID, SUM(TS.LINECOUNT) AS TSLINES FROM TBLTRANSCRIPTIONSTATUS TS, TBLTRANSCRIPTIONMAIN T"
        strQuery = strQuery & " WHERE T.STATUS = '1073741824' and T.TRANSCRIPTIONID NOT IN (SELECT TRANSCRIPTIONID FROM TBLAUDITEPTL) AND TS.TRANSCRIPTIONID = T.TRANSCRIPTIONID AND "
        ...
        strQuery = strQuery & " LEFT JOIN (SELECT TS.USERID, SUM(TS.LINECOUNT) AS TSLINES FROM TBLTRANSCRIPTIONSTATUS TS, TBLTRANSCRIPTIONMAIN T"
        strQuery = strQuery & " WHERE T.STATUS = '1073741824' and T.TRANSCRIPTIONID IN (SELECT TRANSCRIPTIONID FROM TBLAUDITEPTL) AND TS.TRANSCRIPTIONID = T.TRANSCRIPTIONID AND "
        strQuery = strQuery & " TS.USERLEVEL = '8'  "
        ...
        strQuery = strQuery & " LEFT JOIN (SELECT TS.USERID, SUM(TS.LINECOUNT) AS TSLINES FROM TBLTRANSCRIPTIONSTATUS TS, TBLTRANSCRIPTIONMAIN T"
        strQuery = strQuery & " WHERE T.STATUS = '1073741824' and TS.TRANSCRIPTIONID = T.TRANSCRIPTIONID AND TS.USERLEVEL = '2'  "
        ...
        Try
            ...
            For Each DRRecT As DataRow In objDS.Tables(0).Rows
                ...
                DailyTLines = CInt(DRRecT(4).ToString) + (CInt(DRRecT(5).ToString)) + CInt(DRRecT(6).ToString) + (CInt(DRRecT(7).ToString)) + (CInt(DRRecT(8).ToString)) + (CInt(DRRecT(9).ToString)) + CInt(DRRecT(10).ToString)
                MonTLines = CInt(DRRecT(11).ToString) + (CInt(DRRecT(12).ToString)) + CInt(DRRecT(13).ToString) + (CInt(DRRecT(14).ToString)) + (CInt(DRRecT(15).ToString)) + (CInt(DRRecT(16).ToString)) + CInt(DRRecT(17).ToString)
