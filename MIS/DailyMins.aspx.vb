...
Partial Class MIS_DailyMins
    ...
    Protected Sub ShowActDetails()
        ...
        Try
            ...
            DS = clsMIS.GetDMRSubBrkUpByParm(InpDate, CurrSDate, CurrEDate.AddDays(1), New System.Guid(Session("contractorID").ToString), Session("WorkGroupID").ToString, DLInstance.SelectedValue)
            If DS.Tables.Count > 0 Then
                If DS.Tables(0).Rows.Count > 0 Then
                    For Each DRRec1 As DataRow In DS.Tables(0).Rows
                        ...
                        Else
                            Cell1.HorizontalAlign = HorizontalAlign.Left
                            Cell1.Text = "<a href='DailyMins.aspx?showDict=Yes&accountid=" & DRRec1(0).ToString & "&InpDate=" & InpDate & "'>" & DRRec1(1).ToString & "</a>"
    ...
    Protected Sub ShowDictDetails(ByVal ActID As String, ByVal inpDate As Date)
        ...
        Try
            clsMIS = New ETS.BL.MISReports
            DS = clsMIS.GetDMRSubDictByParm(inpDate, New System.Guid(ActID), CurrSDate, CurrEDate.AddDays(1), DLInstance.SelectedValue)
            If DS.Tables.Count > 0 Then
                If DS.Tables(0).Rows.Count > 0 Then
                    R1Cell4.Text = inpDate
                    R1Cell5.Text = DateAdd(DateInterval.Day, -1, inpDate)
    ...
    Protected Sub Button1_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles Button1.Click
        ...
        filename = "DMR By Submit Date " & Month(Now) & Day(Now) & Year(Now) & ".xls"
