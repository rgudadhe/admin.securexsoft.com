<%@ Page Language="VB" AutoEventWireup="false" CodeFile="ViewtransComm.aspx.vb" Inherits="UserPhyAssgn_Default" EnableViewState="True" %>
...
<body onmousedown="javascript: AddTHEAD('Table2')" style="text-align: center">
    <form id="form1" runat="server" defaultbutton="btnsubmit3" >
        ...
        <table id="MainTable" width="100%" style="font-size: 10pt; font-family: 'Trebuchet MS'; font-style: italic;" border ="2" cellpadding ="2" cellspacing ="2" >
                    
                        <tr class="SMSelected">
                            <td colspan="6" style="text-align: center">
                                <b>View Transcription Comments</b></td>
                        </tr>
                        <tr class="SMSelected">
                        ...
                        <tr>
                         <td colspan="1" style="height: 30px; text-align: center; ">
                                <asp:DropDownList ID="DLCommType" runat="server" Font-Names="Trebuchet MS" Font-Size="Small">
                                </asp:DropDownList></td>
                                 <td colspan="1" style="height: 30px; text-align: center; ">
                                     <asp:TextBox ID="txtjobNum" runat="server"></asp:TextBox></td>
                            <td colspan="1" style="height: 30px; text-align: center; ">
