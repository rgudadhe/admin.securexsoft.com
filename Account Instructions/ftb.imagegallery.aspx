...
protected void Page_Load(Object Src, EventArgs E) {
	...
	if (currentFolder == "images/") {
		...
		string[] defaultDirectories = System.IO.Directory.GetDirectories(Server.MapPath("/images"),"*");
		
		// user defined custom directories
		string[] customDirectories = new string[] {"Account Instructions"};
	...
	//if (currentFolder == "images/") {
		...
		//System.IO.DirectoryInfo directoryInfo = new System.IO.DirectoryInfo(Server.MapPath("/images"));
