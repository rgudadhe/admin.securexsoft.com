<%@ Page Language="VB" AutoEventWireup="false" CodeFile="IndirectJobsMT.aspx.vb" Inherits="RoutingTool_Default"   %>
                            ...
                            <tr>
                                <td style="text-align: left">
                                    <asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Always">   <ContentTemplate>  
                                        ...
                                        <asp:DropDownList ID="DLChoice" runat="server"  Font-Bold="True"
                                            Font-Names="Trebuchet MS" Font-Size="Small">
                                        </asp:DropDownList>
                                       </ContentTemplate>  </asp:UpdatePanel>  
                                    <asp:Button ID="Button1" runat="server" Text="Assign" /></td> 
                            </tr>
                        </table>
