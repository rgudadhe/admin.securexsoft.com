...
Partial Class RoutingTool_Default
    ...
    Sub ActStatus()
        ...
        Dim X As Integer
        X = 0
        strQuery = "Select Levelname, LevelNo from tblProductionLevels where contractorid='" & Session("contractorid") & "' and JobsRouting = 'True'  and LevelNo < " & ProLevel.Value & " and LevelNo not in ('1073741824', '2147483647') "
