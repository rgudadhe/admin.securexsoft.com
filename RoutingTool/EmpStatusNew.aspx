<%@ Page Language="VB" AutoEventWireup="false" CodeFile="EmpStatusNew.aspx.vb" Inherits="RoutingTool_Default" %>
...
<body>
   <form id="form1" runat="server">
            ...
            <table id="Table1" border="2" cellpadding="2" cellspacing="2" style="font-size: 10pt;
               ...
               <td style="width: 15%" >
                ...
                <tr>
                   ...
                   <br />
                   <%--<asp:Button ID="lblDsp" runat="server" Text="Button" />--%>
                   <asp:Button ID="btnShowAccPending" runat="server" Text="Show Account Users Pending" Font-Names="Trebuchet MS" Font-Size="8pt"  />
                   <asp:Button ID="btnAccAssignedUsers" runat="server" Text="Show Assigned Account Users" Font-Names="Trebuchet MS" Font-Size="8pt" />
                   <asp:Button ID="btnShowAllUsrs" runat="server" Text="Show All Users" Font-Names="Trebuchet MS" Font-Size="8pt" />
                </td></tr> 
                <tr>
       ...
       <asp:HiddenField ID="hdnLevelNo" runat="server" />
        <br />
        <br />
        <br />
    </form>
