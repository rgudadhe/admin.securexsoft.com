<%@ Page Language="VB" AutoEventWireup="false" CodeFile="LateJobs.aspx.vb" Inherits="RoutingTool_Default"   %>
       ...
       <br />
                        <table id="Table5" runat="server" width="100%">
                            ...
                            <input onclick="javascript:changeAll();"  id="SelJob" type="checkbox" /></asp:TableCell>
                                            <asp:TableCell ID="TableCell2" CssClass="alt1" runat="server">Job#</asp:TableCell>
                                            <asp:TableCell ID="TableCell3" CssClass="alt1" runat="server">Status</asp:TableCell>
                                            <asp:TableCell ID="TableCell4" CssClass="alt1" runat="server">Username</asp:TableCell>
                                            <asp:TableCell ID="TableCell5" CssClass="alt1" runat="server">TAT</asp:TableCell>
                                               <asp:TableCell CssClass="alt1" ID="TableCell6" runat="server">Downloaded</asp:TableCell>
                                            <asp:TableCell ID="TableCell7" CssClass="alt1" runat="server">Priority</asp:TableCell>
                                            <asp:TableCell ID="TableCell8" CssClass="alt1" runat="server">Duration</asp:TableCell>
                                            <asp:TableCell ID="TableCell9" CssClass="alt1" runat="server">Submit Date</asp:TableCell>
                                            <asp:TableCell CssClass="alt1" ID="TableCell10" runat="server">Due Date</asp:TableCell>
                                             <asp:TableCell CssClass="alt1" ID="TableCell11" runat="server">Ramaining TAT</asp:TableCell>
                                            <asp:TableCell ID="TableCell12" CssClass="alt1" runat="server">Account Name</asp:TableCell>
                                            <asp:TableCell ID="TableCell13" CssClass="alt1" runat="server">Physician Name</asp:TableCell>
                            ...
                            <tr>
                                <td style="text-align: left">
                                    <asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Always">   <ContentTemplate>  
                                        ...
                                        <asp:DropDownList ID="DLUser" Visible="False"  runat="server"  CssClass="common"> 
                                              </asp:DropDownList>
