<%@ Page Language="VB" AutoEventWireup="false" CodeFile="STATJobsNew.aspx.vb" Inherits="RoutingTool_Default"   %>
       ...
       <asp:Panel ID="Panel1" runat="server" HorizontalAlign="Left">
            <br />
                        <strong>Selected Mins : &nbsp;</strong><asp:Label ID="lblmins" runat="server" Font-Bold="True"
                            Font-Italic="False" Font-Names="Trebuchet MS" ForeColor="#C00000"></asp:Label>
                        &nbsp; &nbsp; &nbsp; <strong>Selected Jobs : &nbsp;</strong><asp:Label ID="lbljobs"
                            runat="server" Font-Bold="True" Font-Italic="False" Font-Names="Trebuchet MS" ForeColor="#C00000"></asp:Label><br />
       <br />
                        <table id="Table5" runat="server" width="100%" border="2" cellpadding="2" cellspacing="2" style="font-family:Trebuchet MS; font-size:10pt;">
                            <tr>
                            ...
                            <tr>
                                <td style="text-align: center" valign="top">
                                    <asp:Table ID="Table4" runat="server" Width="100%" GridLines="Both">
                                        <asp:TableRow ID="TableRow1" runat="server" style="text-align: center" CssClass="SMSelected">
                            ...
                            <input onclick="javascript:changeAll();" id="SelJob" type="checkbox" /></asp:TableCell>
                                            ...
                                            <asp:TableCell ID="TableCell6" runat="server">Downloaded</asp:TableCell>
                                            <asp:TableCell ID="TableCell7" runat="server">Priority</asp:TableCell>
                                            <asp:TableCell ID="TableCell8" runat="server">Duration</asp:TableCell>
                                            <asp:TableCell ID="TableCell9" runat="server">Submit Date</asp:TableCell>
                                            <asp:TableCell ID="TableCell10" runat="server">Due Date</asp:TableCell>
                                            <asp:TableCell ID="TableCell11" runat="server">Ramaining TAT</asp:TableCell>
                                            <asp:TableCell ID="TableCell12" runat="server">Account Name</asp:TableCell>
                                            <asp:TableCell ID="TableCell13" runat="server">Physician Name</asp:TableCell>
                                            <asp:TableCell CssClass="alt1" ID="TableCell14" runat="server">Direct</asp:TableCell>
                                        </asp:TableRow>
                                    </asp:Table>
                                </td>
                            </tr>
                            ...
                            <tr>
                                <td style="text-align: left">
                                    <asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Always">   <ContentTemplate>  
                                        <asp:DropDownList ID="DLStatus" runat="server" AutoPostBack="True" Font-Names="Trebuchet MS" Font-Size="10pt">
                                        </asp:DropDownList>
                                        <asp:DropDownList ID="DLChoice" runat="server"  CssClass="common" Font-Names="Trebuchet MS" Font-Size="10pt">
                                        </asp:DropDownList>
                                        <asp:DropDownList ID="DLUser" Visible="False"  runat="server" Font-Names="Trebuchet MS" Font-Size="10pt"> 
                                              </asp:DropDownList> 
