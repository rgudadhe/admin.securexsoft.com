<%@ Page Language="VB" AutoEventWireup="false" CodeFile="AccountsRouting.aspx.vb" Inherits="RoutingTool_Default"   %>
       ...
       <br />
                        <table id="Table5" runat="server" width="100%">
                            ...
                            <input onclick="javascript:changeAll();" id="SelJob" type="checkbox" /></asp:TableCell>
                                            ...
                                            <asp:TableCell ID="TableCell6" CssClass="alt1" runat="server">Priority</asp:TableCell>
                                            <asp:TableCell ID="TableCell7" CssClass="alt1" runat="server">Duration</asp:TableCell>
                                            <asp:TableCell ID="TableCell8" CssClass="alt1" runat="server">Submit Date</asp:TableCell>
                                            <asp:TableCell CssClass="alt1" ID="TableCell9" runat="server">Due Date</asp:TableCell>
                                             <asp:TableCell CssClass="alt1" ID="TableCell10" runat="server">Ramaining TAT</asp:TableCell>
                                            <asp:TableCell ID="TableCell11" CssClass="alt1" runat="server">Account Name</asp:TableCell>
                                            <asp:TableCell ID="TableCell12" CssClass="alt1" runat="server">Physician Name</asp:TableCell>
                                            <asp:TableCell CssClass="alt1" ID="TableCell13" runat="server">Direct</asp:TableCell>
                            ...
                            <tr>
                                <td style="text-align: left">
                                    ...
                                    <asp:Button ID="Button1" runat="server" Text="Assign" CssClass="button" />
                                    </td> 
                            </tr>
                        </table>
