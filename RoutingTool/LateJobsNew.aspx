<%@ Page Language="VB" AutoEventWireup="false" CodeFile="LateJobsNew.aspx.vb" Inherits="RoutingTool_Default"   %>
       ...
       <asp:ScriptManager ID="ScriptManager1" runat="server">
        ...
        <br />
                        <strong>Selected Mins : &nbsp;</strong><asp:Label ID="lblmins" runat="server" Font-Bold="True"
                            Font-Italic="False" CssClass="common" ForeColor="#C00000"></asp:Label>
                        &nbsp; &nbsp; &nbsp; <strong>Selected Jobs : &nbsp;</strong><asp:Label ID="lbljobs"
                            runat="server" Font-Bold="True" Font-Italic="False" CssClass="common" ForeColor="#C00000"></asp:Label><br />
       <br />
                        <table id="Table5" runat="server" width="100%" border="2" cellpadding="2" cellspacing="2" style="font-family:Trebuchet MS; font-size:10pt;">
                            ...
                            <input onclick="javascript:changeAll();"  id="SelJob" type="checkbox" /></asp:TableCell>
                                            ...
                                            <asp:TableCell ID="TableCell14" runat="server">Direct</asp:TableCell>
                            ...
                            <tr>
                                <td style="text-align: left">
                                    <asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Always">   <ContentTemplate>  
                                        ...
                                        <asp:DropDownList ID="DLUser" Visible="False"  runat="server"  CssClass="common" Font-Names="Trebuchet MS" Font-Size="10pt"> 
                                              </asp:DropDownList>
