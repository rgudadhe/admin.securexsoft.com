<%@ Page Language="VB" AutoEventWireup="false" CodeFile="AccountStatus.aspx.vb" Inherits="RoutingTool_Default"   %>
...
<body onunload="RefWindow();" onload="unselect();" >
   <form id="form1" runat="server">
       <asp:ScriptManager ID="ScriptManager1" runat="server">
                        ...
                        <br />
                        <strong>Selected Mins : &nbsp;</strong><asp:Label ID="lblmins" runat="server" 
                            Font-Italic="False" CssClass="common" ></asp:Label>
                        &nbsp; &nbsp; &nbsp; <strong>Selected Jobs : &nbsp;</strong><asp:Label ID="lbljobs"
                            runat="server" Font-Italic="False" CssClass="common" ></asp:Label><br />
       <br />
