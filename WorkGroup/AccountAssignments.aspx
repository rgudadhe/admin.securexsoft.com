<%@ Page Language="VB" AutoEventWireup="false" CodeFile="AccountAssignments.aspx.vb" Inherits="WorkGroup_AccountAssignments" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head runat="server">
    <title>WorkGroups Account Assignments</title>
                    ...
                    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                        <ContentTemplate>
                            <table class="common" border="0">
                                ...
                                <tr>
                                    <td class="alt1">
                                        <div style="text-align:center">Assigned Accounts</div>
                                    </td>
                                    <td class="alt1" align="center" style="width:30px;">
                                        &nbsp;
                                    </td>
                                    <td class="alt1" align="center">
                                        <div style="text-align:center">Available Accounts</div>
                                    </td>
                                </tr>
                                <tr>
                                    <td >
