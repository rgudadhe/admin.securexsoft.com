...
Partial Class Account_PlatWeightage
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        If Not IsPostBack Then
            ...
            Try
                oConn.Open()
                Dim SQLCmd2 As New SqlCommand("Select AccountName, AccountID from tblaccounts where indirect = 'True' and contractorID='" & Session("ContractorID") & "' and (IsDeleted is null or IsDeleted=0)", oConn)
    ...
    Protected Sub InsertRec(ByVal PlatformID As String, ByVal Username As String, ByVal JobNumber As String, ByVal Level As String, ByVal Lines As Double, ByVal Dictator As String, ByVal Postdate As Date)
        ...
        Try
            oConn.Open()
            strQuery = "INSERT INTO [dbo].[tblUserPlatLines] (PlatActID, Username, JobNumber, UserLevel, Lines, Dictator, PostDate,updatedate ) VALUES "
    ...
    Protected Sub UpdateRec(ByVal Username As String, ByVal Lines As Double, ByVal Dictator As String, ByVal PostDate As Date, ByVal JobNumber As String, ByVal Level As String)
        ...
        Try
            oConn.Open()
            strQuery = "UPDATE [dbo].[tblUserPlatLines]  SET Username = '" & Username & "' ,Lines = '" & Lines & "' ,Dictator =  '" & Dictator & "', updatedate = '" & Now & "' WHERE JobNumber = '" & JobNumber & "' and userLevel  = '" & Level & "'"
            'Response.Write(strQuery)
            Dim SQLCmd3 As New SqlCommand(strQuery, oConn)
            SQLCmd3.ExecuteNonQuery()
        Catch ex As Exception
            ...
            Try
                ...
                If DRRec1.HasRows Then
                    While (DRRec1.Read)
                        ...
                        strQuery = "Select * from dbo.tblUserPlatLines where PlatActID='" & DLPlatform.SelectedValue & "' and JobNumber='" & JobNumber & "' and UserLevel = '" & Level & "' "
                        Dim SQLCmd3 As New SqlCommand(strQuery, oConn)
