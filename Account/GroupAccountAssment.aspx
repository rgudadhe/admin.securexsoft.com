<%@ Page Language="VB" AutoEventWireup="false" CodeFile="GroupAccountAssment.aspx.vb" Inherits="UserPhyAssgn_Default" EnableViewState="True" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 1.0 Transitional/EN">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head runat="server">
    <title>Group Account Assignment</title>
...
<body>
                ...
                <td style="width: 50%; text-align: center;" valign="top">
                    ...
                    <asp:Panel ID="Panel2" runat="server" Width="100%"><asp:Table ID="TblGrpSeach" runat="server" Width="100%" >
                        ...
                        <asp:TableRow runat="server" style="text-align: center">
                            ...
                            <asp:TableCell CssClass="alt1" runat="server">Group Account Name</asp:TableCell>
                            <asp:TableCell CssClass="alt1" runat="server">Group Account Number</asp:TableCell>
                        </asp:TableRow>
                        </asp:Table>
    ...
    ErrorMessage="Group Account Name - Please enter valid input."
   />
