<%@ Page Language="VB" AutoEventWireup="false" CodeFile="AccountTATAssment.aspx.vb" Inherits="AccountTATAssment" EnableViewState="True" %>
   ...
   function addRowToTable()
{
  ...
  var sel1 = document.getElementById('TAT1').cloneNode(true);
  sel1.name = 'TAT' + iteration;
  sel1.value='';
  ...
  sel3.setAttribute("name",'TrackID' + iteration);
                    ...
                    <asp:Panel ID="Panel7" runat="server" Width="100%"><asp:Table ID="Table3" runat="server" Width="100%" >
                        ...
                        <asp:Table ID="Table2" runat="server" Width="100%">
                            <asp:TableRow ID="TableRow3" runat="server" style="text-align: center">
                                <asp:TableCell ID="TableCell6" CssClass="alt1" runat="server">TAT</asp:TableCell>
                                
                            </asp:TableRow>
                            <asp:TableRow ID="TableRow4" runat="server">
                                <asp:TableCell ID="TableCell8" runat="server">
                                    <asp:TextBox ID="TAT1" runat="server"></asp:TextBox>
                                    <asp:HiddenField ID="hdnTrackID1" runat="server" />
                                </asp:TableCell>
                                
                            </asp:TableRow>
                        </asp:Table>
                    
                    <input id="Button1" type="button" value="Add TAT" class="button" onclick="addRowToTable()"/>
                    
                    <input id="Button2" type="button" value="Remove TAT" class="button" onclick="removeRowFromTable()"/>
                        </asp:Panel>
                        </td>
            </tr>
            <tr>
                ...
                <td colspan="2" style="text-align: center">
                    <asp:Table ID="Table4" runat="server" Width="100%">
                        <asp:TableRow ID="TableRow5" runat="server" style="text-align: center">
                            ...
                            <asp:TableCell ID="TableCell11" CssClass="alt1" runat="server">TAT</asp:TableCell>
