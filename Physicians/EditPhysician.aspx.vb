...
Partial Class Department_Default
    ...
    Sub ShowData(ByVal PhyID As String)
        ...
        With clsPhy
            ...
            .PhysicianID = PhyID
            .getPhysicianDetails()
            'Response.Write("FaxPlus: " & .FaxPlus)
            'Response.Write("<br>Demobusting: " & .DemoBusting)
            ...
            Else
                Image1.Visible = True
                Image1.ImageUrl = WebAddress & "\ets_files\ESignature1\" & HDictID.Value & ".jpg" & "?dt=" & Now.ToString("MMddyyyhhmmsstt")
            End If

            'If .ESignMode Then
            '    DLSignMode.Items(0).Selected = False
            '    DLSignMode.Items(1).Selected = True
            'Else
            '    DLSignMode.Items(1).Selected = False
            '    DLSignMode.Items(0).Selected = True
            'End If
            ...
            If .sendfax Then
                DDLFaxmode.Enabled = True
                chkException.Enabled = True
                If .FaxPlusMode Then
                ...
                Else
                    ...
                    chkException.Checked = .RepException
                End If
            ...
            Else
                ...
                DDLFaxmode.Items(1).Selected = True
                chkException.Checked = False
                DDLFaxmode.Enabled = False
                chkException.Enabled = False
            End If
          

            If .FaxPlus Then
                DDLAutoFax.Enabled = True
    ...
    Protected Sub ImageButton1_Click1(ByVal sender As Object, ByVal e As System.EventArgs) Handles ImageButton1.Click
        Try
            ...
            With clsPhy
                ...
                ' .ESignMode = DLSignMode.SelectedValue
                .Fax = Request("TxtFax")
                ...
                If chkFax.Checked Then
                    ...
                    .RepException = chkException.Checked
                End If
    ...
    Protected Sub DDLFaxmode_SelectedIndexChanged(sender As Object, e As System.EventArgs) Handles DDLFaxmode.SelectedIndexChanged
        If DDLFaxmode.SelectedIndex = 0 Then
            chkException.Enabled = False
        Else
            chkException.Enabled = True
    ...
    Protected Sub chkFax_CheckedChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles chkFax.CheckedChanged
        If chkFax.Checked Then
            DDLFaxmode.Items(0).Selected = False
            DDLFaxmode.Items(1).Selected = True
            chkException.Checked = False
