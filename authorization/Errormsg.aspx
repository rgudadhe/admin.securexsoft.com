<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Errormsg.aspx.vb"
                    ...
                    <div style="background: #ffffff url('../images/registration-bg.jpg') no-repeat; width: 905px;
                        ...
                        <div class="activate">
                            ...
                            <br />
                               ...
                               <h2>You have not completed your registration process!</h2>
                            <p  style=" font-size: 17px;">
                                Please click on below button to Login and complete your registration process.</p>
