<%@ Page Language="VB" AutoEventWireup="false" CodeFile="userquestionreset.aspx.vb" Inherits="authorization_userquestionreset" %>
            ...
            <div class="container">
                <div style="background: #ffffff url('../images/UserReg-bg.jpg') no-repeat; width: 905px;
                    ...
                    <div class="activate">
                        <br />
                        <h2>
                            Reset Secret Questions and Answer</h2>
                    </div>
                    <div class="form2">
                        <div class="row">
                          <%--  <div class="col-md-4">
