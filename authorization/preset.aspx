<%@ Page Language="VB" AutoEventWireup="false" CodeFile="preset.aspx.vb" Inherits="Passwordmodule_preset" %>
...
<body>
        ...
        <div class="features">
            <div class="container">
                <div style="background: #ffffff url('../images/UserReg-bg.jpg') no-repeat; width: 905px;
                    height: 720px; margin: 0 auto; padding: 20px">
                    <div class="activate">
                 <h2>
                            Reset Password</h2>
                    </div>
                        ...
                        <div class="row">
                            <div class="col-md-4" style="text-align: right;">
                                <div class="form-group">
                                 <label for="usr" >   <asp:Label ID="Label1" runat="server" Text=""></asp:Label></label>
                                </div>
                            </div>
                            <div class="col-md-4" style="text-align: right;">
                                <div class="form-group">
                                    ...
                                    <div class="para">
                                    <asp:Label ID="Label3" runat="server" Text="" Width="550px"></asp:Label>
                                    </div>
    ...
    <asp:HiddenField ID="hans" runat="server" />
            ...
            <tr>
                <td  class="DEMO5">
                    ...
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ErrorMessage="New Password is required "
                        ControlToValidate="TxtNewPass"></asp:RequiredFieldValidator><br />
                    <asp:RegularExpressionValidator Display="Dynamic" ID="RegularExpressionValidator2"
                        ErrorMessage="Password must be 8 characters long with numeric, <br />alphabet and special character."
                        ForeColor="Red" ValidationExpression="^(?=.*[a-z])(?=.*[A-Z])(?=.*\d)(?=.*[$@$!%*?&])[A-Za-z\d$@$!%*?&]{8,}"
                        ControlToValidate="TxtNewPass" runat="server" Font-Size="Smaller"></asp:RegularExpressionValidator>
                </td>
            </tr>
    ...
    <%-- <asp:Label ID="Label2" runat="server" ForeColor="#009900" Font-Size="Small"></asp:Label><br />
