<%@ Page Language="VB" AutoEventWireup="false" CodeFile="AddSystemAlerts.aspx.vb" Inherits="SystemAlerts" %>
     ...
     <table width="80%">
            ...
            <tr>
                <td style="text-align: right" valign="top"  >
                    Alert</td>
                <td style="text-align: left;">
                    <asp:TextBox ID="TxtAlert" runat="server" CssClass="common" TextMode="MultiLine" Height="168px" Width="520px"></asp:TextBox></td>
            </tr>
            <tr>
        ...
        <br />
        <a href="ViewSystemAlerts.aspx" target="_self" ><strong><span class="common">View System Alerts</span></strong></a>
        </div> 
        </div>
        </asp:Panel>
    </form>
