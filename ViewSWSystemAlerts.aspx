<%@ Page Language="VB" AutoEventWireup="false" CodeFile="ViewSWSystemAlerts.aspx.vb" Inherits="ViewUpd" %>
               ...
               <asp:CompleteGridView ID="MyDataGrid" runat="server" AllowSorting="True" 
                ...
                <PagerSettings PreviousPageText="Previous" PageButtonCount="25" Mode="NumericFirstLast" LastPageText="Last Page" FirstPageText="First Page" NextPageText="Next Page"></PagerSettings>
                          ...
                          <Columns>
                              ...
                              <asp:BoundField ControlStyle-Width = "95%" DataField="ActDate"   HeaderText="Date" SortExpression="ActDate" HeaderStyle-CssClass="alt1" />
                              <asp:BoundField ControlStyle-Width = "100%" DataField="Alert"  HeaderText="System Alert" SortExpression="Alert" HeaderStyle-CssClass="alt1" />
