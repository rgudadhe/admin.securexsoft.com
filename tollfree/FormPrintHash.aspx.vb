...
Partial Class FormPrintHash
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If custid = "2911ba15-9936-4c1e-992f-73398cdffbc8" Then
            ph1.Text = "(850)-757-0050"
            ph2.Text = "(850)-888-3033 and Ext. 2990"
        Else
            ph1.Text = "(866)-239-1729"
            ph2.Text = "(800)-385-4418"
        End If
        ...
        If tval = 1 Then
            ...
            con.Open()
            Dim prmptcmd As New SqlCommand("select * from tblprompts where custid='" & custid & "' order by keyin", con)
            ...
            If prmptds.Tables(0).Rows.Count > 0 Then
                ...
                If mds.Tables(0).Rows.Count > 0 Then
                    Label6.Text = "<b>>> </b>Enter Patient Medical Record Number followed by # sign"
                Else
                    Label6.Text = ""
                End If
