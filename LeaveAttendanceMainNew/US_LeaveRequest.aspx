<%@ Page Language="VB" AutoEventWireup="false" CodeFile="US_LeaveRequest.aspx.vb" Inherits="USLeaveRequest" Debug="true" %>
                    ...
                    <asp:TableCell HorizontalAlign="Center" ColumnSpan="2">
                        <center>
                            ...
                            <asp:DropDownList ID="DropLeaveType" CssClass="common" runat="server" >
                                ...
                                <asp:ListItem Text="Full Day (8 Hours)" Value="EL"></asp:ListItem>
                                <asp:ListItem Text="Half Day(4 Hours)" Value="ELHL"></asp:ListItem>
                                <asp:ListItem Text="Leave Without Pay(8 Hours)" Value="LWP"></asp:ListItem>
                                <asp:ListItem Text="Leave Without Pay(4 Hours)" Value="LWPHL"></asp:ListItem>
                            </asp:DropDownList>
                        </center>
                    </asp:TableCell>
                </asp:TableRow>
