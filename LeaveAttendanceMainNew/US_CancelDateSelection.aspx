<%@ Page Language="VB" AutoEventWireup="false" CodeFile="US_CancelDateSelection.aspx.vb" Inherits="USCancelDateSelection" %>
...
<body>
    ...
    <div style="width:100%; height:250px">
        <asp:Table runat="server" ID="tblMain" HorizontalAlign="Center" style="width:100%; height:150px">
            <asp:TableRow ID="tblNote" Visible="false">
            ...
            <asp:TableRow>
                <asp:TableCell>
                    <center>
                        <asp:TextBox ID="txtStartDate" runat="server" Width="70px" ReadOnly="true" CssClass="common" Enabled="false"></asp:TextBox>    
                        <asp:ImageButton ID="imgSDate" CausesValidation="false" ImageUrl="~/App_Themes/Images/Calendar_scheduleHS.png" runat="server" Visible="false"/> &nbsp &nbsp
                ...
                <asp:TableCell>
                    <center>
                        <asp:TextBox ID="txtEndDate" runat="server" Width="70px" ReadOnly="true" Enabled="false"></asp:TextBox>
                        <asp:ImageButton ID="imgEDate" ImageUrl="~/App_Themes/Images/Calendar_scheduleHS.png" CausesValidation="false" runat="server" Visible="false"/>
