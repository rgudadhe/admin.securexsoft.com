<%@ Page Language="VB" AutoEventWireup="false" CodeFile="US_Employee.aspx.vb" Inherits="LeaveAttendanceMainNew_Employee_USEmployee" %>
    ...
    <div>
        ...
        <Ajax:TabContainer ID="EmpTabContainer" runat="server" Width="100%" ScrollBars="None" ActiveTabIndex="0" AutoPostBack="true">
            ...
            <Ajax:TabPanel ID="SendRequest1" runat="server" Height="700">
                ...
                <ContentTemplate>
                    <iframe width="20%" height="410"  frameborder="0"  src="US_LeftRequestFrame.aspx" id="LeftFrame"></iframe>
                    <iframe width="80%" height="410"  frameborder="0" src="US_RigthReuestFrame.aspx"  id="RightFrame" style="float:right;"></iframe>   
                </ContentTemplate>
            </Ajax:TabPanel>
            <Ajax:TabPanel ID="Status" runat="server" visible="false" >
                <HeaderTemplate>
                    <asp:Label ID="LeaveStatus" runat="server" Text="Leave Status" CssClass="common" Visible="false"></asp:Label>
                </HeaderTemplate>
                <ContentTemplate>
            ...
            <Ajax:TabPanel ID="DutyRoster" runat="server" visible="false">
                <HeaderTemplate>
                    <asp:Label ID="lblDuty" runat="server" Text="Duty Roster" CssClass="common" visible="false"></asp:Label>    
                </HeaderTemplate>
                <ContentTemplate>
