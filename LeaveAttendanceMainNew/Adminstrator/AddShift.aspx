<%@ Page Language="VB" AutoEventWireup="false" CodeFile="AddShift.aspx.vb" Inherits="TechReports_AddShift" %>
...
<body>
    ...
    <div>
        ...
        <BR>
        <BR>
            <asp:Button ID="BtnSubmit" Font-Names="Trebuchet MS" runat="server" Text="Submit" CssClass="Buttons" />
        </center>
    </div>
    </form>
</body>
