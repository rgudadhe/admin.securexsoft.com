<%@ Page Language="VB" AutoEventWireup="false" CodeFile="US_LeaveCanReq.aspx.vb" Inherits="USLeaveCanReq" %>
                    ...
                    <asp:GridView ID="GridViewCancel" runat="server" AutoGenerateColumns="false" Width="100%">
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="Cancel" ItemStyle-HorizontalAlign="Left" HeaderStyle-CssClass="Header" > 
                        		<ItemTemplate>
                            	    <a href="US_CancelDateSelection.aspx?LeaveID=<%# DataBinder.Eval(Container.DataItem, "LeaveID" )%>" onclick="window.open('US_CancelDateSelection.aspx?LeaveID=<%# DataBinder.Eval(Container.DataItem, "LeaveID" )%>','', 'width=450,height=240,status=1,scrollbars=1');return false;">Cancel</a>
                        		</ItemTemplate>
                    	    </asp:TemplateField>
                        </Columns>
                    </asp:GridView>
