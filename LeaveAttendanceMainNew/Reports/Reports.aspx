<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Reports.aspx.vb" Inherits="LeaveAttendanceMainNew_Reports_Reports" %>
    ...
    <div>
        ...
        <Ajax:TabContainer ID="ReportTabContainer" AutoPostBack="true" runat="server" Width="100%" ScrollBars="None" ActiveTabIndex="0">
            <Ajax:TabPanel ID="Att" runat="Server">
                ...
                <ContentTemplate>
                    <iframe width="100%" frameborder="0" src="AttendanceReports.aspx" id="DutyRosterframe" height="420" scrolling="auto"></iframe>
                </ContentTemplate>
            </Ajax:TabPanel>
            <Ajax:TabPanel ID="DailyAtt" runat="server">
                <HeaderTemplate>
                    <asp:Label ID="Label2" CssClass="common" runat="server" Text="Daily Attendance"></asp:Label>
                </HeaderTemplate>
                <ContentTemplate>
                    <iframe width="100%" frameborder="0" src="TechDailyAttendance.aspx" id="Iframe1" height="420" scrolling="auto"></iframe>
                </ContentTemplate>
            </Ajax:TabPanel>
            <Ajax:TabPanel ID="LeaveSanctioned" runat="Server">
                <HeaderTemplate>
                    <asp:Label ID="Label3" runat="server" CssClass="common" Text="Leave Sanctioned"></asp:Label>
                </HeaderTemplate>
                <ContentTemplate>
            ...
            <Ajax:TabPanel ID="LeaveReport" runat="server">
                ...
                <ContentTemplate>
                    <iframe width="100%" frameborder="0" src="LeaveReport.aspx" id="Iframe3" height="420" scrolling="auto"></iframe>
                </ContentTemplate>
            </Ajax:TabPanel>
            <Ajax:TabPanel ID="TabPanel1" runat="server" BorderColor="lightblue">
                <HeaderTemplate>
                    <asp:Label ID="Label5" runat="server" CssClass="button" Text="Duty Roster"></asp:Label>
                </HeaderTemplate>
                <ContentTemplate>   
