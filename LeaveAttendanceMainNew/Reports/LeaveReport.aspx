<%@ Page Language="VB" AutoEventWireup="false" CodeFile="LeaveReport.aspx.vb" Inherits="LeaveAttendanceMainNew_Reports_LeaveReport" %>
                                    ...
                                    <td align="left" style="border:0">
                                        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="false" Width="100%">
                                            <Columns>
                                                ...
                                                <asp:TemplateField HeaderText="TypeOfLeave" HeaderStyle-CssClass="Header">
                                                    <ItemTemplate><%#Eval("TypeOfLeave")%></ItemTemplate>
                                                </asp:TemplateField>
                                                <asp:TemplateField HeaderText="StartDate" HeaderStyle-CssClass="Header">
                                                    <ItemTemplate><%#Eval("Start Date").ToShortDateString()%></ItemTemplate>
                                                </asp:TemplateField>
                                                <asp:TemplateField HeaderText="EndDate" HeaderStyle-CssClass="Header">
                                                    <ItemTemplate><%#Eval("End Date").ToShortDateString()%></ItemTemplate>
                                                </asp:TemplateField>
                                                <asp:TemplateField HeaderText="Status" HeaderStyle-CssClass="Header">
                                                    <ItemTemplate><%#Eval("Status")%></ItemTemplate>
                                                </asp:TemplateField>
                                                <asp:TemplateField HeaderText="ApplicationDate" HeaderStyle-CssClass="Header">
                                                    <ItemTemplate><%#Eval("Application Date").ToShortDateString()%></ItemTemplate>
                                                </asp:TemplateField>
                                                <asp:TemplateField HeaderText="LeaveCount" HeaderStyle-CssClass="Header">
                                                    <ItemTemplate><%#IIf(Container.DataItem("TypeOfLeave") = "HL" Or Container.DataItem("TypeOfLeave") = "LWPHL" Or Container.DataItem("TypeOfLeave") = "ELHL" Or Container.DataItem("TypeOfLeave") = "CLHL", Container.DataItem("Leave Count") * 0.5, Container.DataItem("Leave Count"))%></ItemTemplate>
                                                </asp:TemplateField>
                                            </Columns>                                            
                                        </asp:GridView>
                                    </td>
