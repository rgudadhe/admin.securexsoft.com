...
Partial Class AttendanceReports
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        If Not Page.IsPostBack Then
            varIntCurrentYear = Year(Now.Date)
            varIntCurrentMonth = Month(Now.Date)
            ...
            'GetWeeklyOff(Year(Now.Date), Month(Now.Date))
            'FillTable(varIntCurrentMonth, varIntCurrentYear, False, True)
        End If
    End Sub
    Protected Sub GetWeeklyOff(ByVal Year As Integer, ByVal Month As Integer)
        ...
        While varDtEndDate >= varDtStartDate
            If Trim(UCase("Sunday")) = Trim(UCase(WeekdayName(Weekday(varDtStartDate)))) Then
                varWeeklyOff(Day(varDtStartDate)) = Day(varDtStartDate)
                w = w + 1
            ElseIf Trim(UCase("Saturday")) = Trim(UCase(WeekdayName(Weekday(varDtStartDate)))) Then
                varWeeklyOff1(Day(varDtStartDate)) = Day(varDtStartDate)
                w = w + 1
            End If
    ...
    End Sub
    Protected Sub FillTable(ByVal varParamMonth, ByVal varParamYear, ByVal Str, ByVal Flag)
        'Get days in month
        Dim varDtTempDate As Date
        ...
        Try
            ...
            For varIntEmpCount = 0 To j - 1
                ...
                For varCount = 1 To UBound(varArrDay)
                    varTempDate = DateSerial(varParamYear, varParamMonth, varCount)
                        ...
                        If DSAtt.Tables(0).Rows.Count > 0 Then
                            ...
                            If oRecAttendance.HasRows Then
                                While oRecAttendance.Read
                                    k = Day(oRecAttendance.GetDateTime(oRecAttendance.GetOrdinal("AttDate")))
                                    varArrAttDate(k) = Day(oRecAttendance.GetDateTime(oRecAttendance.GetOrdinal("AttDate")))
                ...
                For varCount = 1 To UBound(varArrDay)
                    varDtTDate = DateSerial(varParamYear, varParamMonth, varCount)
                    If varLastModified.ToShortDateString.ToString <> "" Then
                        If DateDiff(DateInterval.Day, varLastModified, varDtTDate) < 0 Then
                            If Trim(UCase(varPStrWOff1)) = Trim(UCase(WeekdayName(Weekday(varDtTDate)))) Then
                                varWeeklyOffEmp(Day(varDtTDate)) = Day(varDtTDate)
                            ElseIf Trim(UCase(varPStrWOff2)) = Trim(UCase(WeekdayName(Weekday(varDtTDate)))) Then
                                varWeeklyOff1Emp(Day(varDtTDate)) = Day(varDtTDate)
                            Else
                ...
                For count = 1 To UBound(varArrDay)
                    ...
                    If varArrDay(count) = varArrAttDate(count) Then
                        ...
                        varDtAttDate = DateSerial(DropDownYear.SelectedItem.Value, DropDownMonth.SelectedItem.Value, count)
                    ...
                    If Trim(UCase(cellStatus.Text)) = Trim(UCase("A")) Or String.IsNullOrEmpty(cellStatus.Text) Then
                        ...
                        varReturnVal = CheckDutyRoseter(DateSerial(varParamYear, varParamMonth, count), varArrUserID(varIntEmpCount).ToString)
    ...
    Protected Sub ES_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles ES.Click
        Try
            ...
            Dim filename = "Attendance Report " & MonthName(Month(Now)) & " " & Year(Now) & ".xls"
