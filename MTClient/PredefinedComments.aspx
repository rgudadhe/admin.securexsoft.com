                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="Comment" HeaderStyle-HorizontalAlign=Center SortExpression="Comment" ItemStyle-Width=500 HeaderStyle-CssClass="alt1">
                                        ...
                                        <FooterTemplate>
                                            ...
                                            <asp:RequiredFieldValidator ID="RequiredFieldCateName" runat="server" ErrorMessage="Please enter Comment" ControlToValidate="txtComment" CssClass="Validation"></asp:RequiredFieldValidator>
